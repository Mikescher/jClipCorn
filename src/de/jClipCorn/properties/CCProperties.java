...
public class CCProperties {
	...
	private void createProperties() {
		...
		PROP_MAINFRAME_DONT_FILTER_WATCHNEVER	= new CCBoolProperty(CAT_COMMON,		this, 	"PROP_MAINFRAME_DONT_FILTER_WATCHNEVER", 	true);
		...
		PROP_MAINFRAME_AUTOMATICRESETWATCHLATER = new CCBoolProperty(CAT_VIEW,		 	this,   "PROP_MAINFRAME_AUTOMATICRESETWATCHLATER",	true);
