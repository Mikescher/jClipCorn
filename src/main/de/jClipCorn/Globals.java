...
public final class Globals {
	...
	public static int TIMING_LOAD_MOVIELIST_FILL_GROUPS   = 0x103;
	public static int TIMING_LOAD_MOVIELIST_FILL_ELEMENTS = 0x104;
	public static int TIMING_LOAD_MOVIELIST_FILL_COVERS   = 0x105;
	public static int TIMING_LOAD_CREATEBACKUP            = 0x106;
	public static int TIMING_LOAD_DATABASE                = 0x107;
	public static int TIMING_LOAD_FILTERS                 = 0x108;
	...
	static {
		...
		TIMING_IDS.put(TIMING_LOAD_MOVIELIST_FILL_GROUPS,   "LOAD_MOVIELIST_FILL_GROUPS");
		TIMING_IDS.put(TIMING_LOAD_MOVIELIST_FILL_ELEMENTS, "LOAD_MOVIELIST_FILL_ELEMENTS");
		TIMING_IDS.put(TIMING_LOAD_MOVIELIST_FILL_COVERS,   "LOAD_MOVIELIST_FILL_COVERS");
		TIMING_IDS.put(TIMING_LOAD_CREATEBACKUP,            "LOAD_CREATEBACKUP");
		TIMING_IDS.put(TIMING_LOAD_FILTERS,                 "LOAD_FILTERS");
