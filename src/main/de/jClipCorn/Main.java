...
public class Main {
	...
	public final static String VERSION           = /*<gradle_version_marker>*/"1.10.11.33"/*</gradle_version_marker>*/;     //$NON-NLS-1$
	public final static String DBVERSION         = "36";                                                                    //$NON-NLS-1$
	public final static String USERDATA_DBVERSION= "1";                                                                     //$NON-NLS-1$
