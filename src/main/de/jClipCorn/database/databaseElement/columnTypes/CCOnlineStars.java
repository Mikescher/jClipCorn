...
public enum CCOnlineStars implements ContinoousEnum<CCOnlineStars> {
	STARS_0_0(0),
	STARS_0_5(1),
	STARS_1_0(2),
	STARS_1_5(3),
	...
	private static final EnumWrapper<CCOnlineStars> wrapper = new EnumWrapper<>(STARS_0_0);

	CCOnlineStars(int val) {
		id = val;
	}
	
	public static EnumWrapper<CCOnlineStars> getWrapper() {
		return wrapper;
	}
	...
	public static int compare(CCOnlineStars o1, CCOnlineStars o2) {
	...
	@Override
	public CCOnlineStars[] evalues() {
		return CCOnlineStars.values();
	}
}
