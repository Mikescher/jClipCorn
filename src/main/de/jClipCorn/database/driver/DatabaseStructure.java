...
public class DatabaseStructure
{
	...
	public final static CCSQLColDef COL_MOV_MI_ACHANNELS     = new CCSQLColDef("MEDIAINFO.ACHANNELS",  CCSQLType.INTEGER,     NULLABLE);
	...
	public final static CCSQLTableDef TAB_MOVIES = new CCSQLTableDef(
			...
			new CCSQLColDef[]
			{
				...
				COL_MOV_SCORE, COL_MOV_COVERID, COL_MOV_MI_FILESIZE, COL_MOV_MI_CDATE,
				COL_MOV_MI_MDATE, COL_MOV_MI_AFORMAT, COL_MOV_MI_VFORMAT, COL_MOV_MI_WIDTH, COL_MOV_MI_HEIGHT,
				COL_MOV_MI_FRAMERATE, COL_MOV_MI_DURATION, COL_MOV_MI_BITDEPTH, COL_MOV_MI_BITRATE, COL_MOV_MI_FRAMECOUNT,
				COL_MOV_MI_ACHANNELS, COL_MOV_MI_VCODEC, COL_MOV_MI_ACODEC, COL_MOV_MI_SAMPLERATE, COL_MOV_MI_CHECKSUM
			},
			new CCSQLFKey[]
			{
	...
	public final static CCSQLTableDef TAB_EPISODES = new CCSQLTableDef(
			...
			new CCSQLColDef[]
			{
				...
				COL_EPIS_MI_ACHANNELS, COL_EPIS_MI_VCODEC, COL_EPIS_MI_ACODEC, COL_EPIS_MI_SAMPLERATE, COL_EPIS_MI_CHECKSUM
			},
			new CCSQLFKey[]
			{
