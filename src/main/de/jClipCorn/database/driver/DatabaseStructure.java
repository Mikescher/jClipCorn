...
public class DatabaseStructure
{
	...
	public final static CCSQLColDef COL_MAIN_MI_CHECKSUM      = new CCSQLColDef("MEDIAINFO.CHECKSUM",   CCSQLType.VARCHAR,     NULLABLE);
	...
	public final static CCSQLTableDef TAB_MAIN = new CCSQLTableDef(
			"ELEMENTS",
			COL_MAIN_LOCALID,
			COL_MAIN_NAME, COL_MAIN_VIEWEDHISTORY, COL_MAIN_ZYKLUS, COL_MAIN_ZYKLUSNUMBER, COL_MAIN_LANGUAGE,
			...
			COL_MAIN_SCORE, COL_MAIN_COVERID, COL_MAIN_TYPE, COL_MAIN_MI_FILESIZE, COL_MAIN_MI_CDATE,
			...
			COL_MAIN_MI_ACHANNELS, COL_MAIN_MI_VCODEC, COL_MAIN_MI_ACODEC, COL_MAIN_MI_SAMPLERATE, COL_MAIN_MI_CHECKSUM);
