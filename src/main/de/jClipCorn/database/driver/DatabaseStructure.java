...
public class DatabaseStructure
{
	...
	public final static CCSQLColDef COL_MOV_TAGS              = new CCSQLColDef("TAGS",                 CCSQLType.VARCHAR,     NON_NULLABLE);
	public final static CCSQLColDef COL_MOV_PARTS             = new CCSQLColDef("PARTS",                CCSQLType.VARCHAR,     NON_NULLABLE);
	
	// Legacy part columns for migration
	...
	public final static CCSQLColDef COL_MOV_CHECKSUM_CRC32   = new CCSQLColDef("CHECKSUM_CRC32",       CCSQLType.VARCHAR,     NULLABLE);
	public final static CCSQLColDef COL_MOV_CHECKSUM_MD5     = new CCSQLColDef("CHECKSUM_MD5",         CCSQLType.VARCHAR,     NULLABLE);
	public final static CCSQLColDef COL_MOV_CHECKSUM_SHA256  = new CCSQLColDef("CHECKSUM_SHA256",      CCSQLType.VARCHAR,     NULLABLE);
	public final static CCSQLColDef COL_MOV_CHECKSUM_SHA512  = new CCSQLColDef("CHECKSUM_SHA512",      CCSQLType.VARCHAR,     NULLABLE);
	public final static CCSQLColDef COL_MOV_SPECIALVERSION    = new CCSQLColDef("SPECIALVERSION",       CCSQLType.VARCHAR,     NON_NULLABLE);
	...
	public final static CCSQLColDef COL_EPIS_CHECKSUM_CRC32  = new CCSQLColDef("CHECKSUM_CRC32",       CCSQLType.VARCHAR,     NULLABLE);
	public final static CCSQLColDef COL_EPIS_CHECKSUM_MD5    = new CCSQLColDef("CHECKSUM_MD5",         CCSQLType.VARCHAR,     NULLABLE);
	public final static CCSQLColDef COL_EPIS_CHECKSUM_SHA256 = new CCSQLColDef("CHECKSUM_SHA256",      CCSQLType.VARCHAR,     NULLABLE);
	public final static CCSQLColDef COL_EPIS_CHECKSUM_SHA512 = new CCSQLColDef("CHECKSUM_SHA512",      CCSQLType.VARCHAR,     NULLABLE);
	...
	public final static CCSQLColDef COL_GRPS_COLOR            = new CCSQLColDef("COLOR",                CCSQLType.VARCHAR,     NON_NULLABLE);
	...
	public final static CCSQLTableDef TAB_MOVIES = new CCSQLTableDef(
			...
			new CCSQLColDef[]
			{
				...
				COL_MOV_CHECKSUM_CRC32, COL_MOV_CHECKSUM_MD5, COL_MOV_CHECKSUM_SHA256, COL_MOV_CHECKSUM_SHA512
			},
			new CCSQLFKey[]
			{
	...
	public final static CCSQLTableDef TAB_EPISODES = new CCSQLTableDef(
			...
			new CCSQLColDef[]
			{
				...
				COL_EPIS_CHECKSUM_CRC32, COL_EPIS_CHECKSUM_MD5, COL_EPIS_CHECKSUM_SHA256, COL_EPIS_CHECKSUM_SHA512
			},
			new CCSQLFKey[]
			{
