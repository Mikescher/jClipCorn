	...
	public void tryUpgrade() {
		try {
			...
			if (version.equals("13")) {
				if (Main.DEBUG) return;//TODO rm me
				upgrade_13_14();
				setDBVersion("14");
				version = "14";
			}
