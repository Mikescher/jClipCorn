...
public class DatabaseXMLImportImpl_V7 implements IDatabaseXMLImporterImpl
{
	...
	public void importMovie(CCMovie o, CCXMLElement e, Func1to1<String, BufferedImage> imgf, ImportState s) throws CCFormatException, CCXMLException
	{
		o.beginUpdating();
		{
			...
			e.execIfAttrExists("subtitles", v -> o.Subtitles.set(CCDBLanguageList.parseFromString(v)));
