...
public class StatisticsMediaInfoAudioCodecChart extends StatisticsChart {
	public StatisticsMediaInfoAudioCodecChart(CCMovieList ml, StatisticsTypeFilter _source) {
		super(ml, _source);
	}
	...
	private DefaultCategoryDataset getDataSet(CCMovieList movielist, StatisticsTypeFilter source) {
		Map<String, Integer> values = source
				...
				.map(e -> e.mediaInfo().get().getAudioCodec())
				.groupBy(e -> e)
	...
	public String createTitle() {
		return LocaleBundle.getString("StatisticsFrame.charttitles.mediainfo_audiocodec"); //$NON-NLS-1$
	}
