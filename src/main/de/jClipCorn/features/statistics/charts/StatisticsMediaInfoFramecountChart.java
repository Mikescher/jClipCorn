...
public class StatisticsMediaInfoFramecountChart extends StatisticsChart {

	public StatisticsMediaInfoFramecountChart(CCMovieList ml, StatisticsTypeFilter _source) {
		super(ml, _source);
	}
	...
	private XYDataset getDataSet(CCMovieList movielist, StatisticsTypeFilter source) {
		List<Integer> values = source
				...
				.map(e -> e.mediaInfo().get().Framecount)
	...
	public String createTitle() {
		return LocaleBundle.getString("StatisticsFrame.charttitles.mediainfo_framecount"); //$NON-NLS-1$
	}
