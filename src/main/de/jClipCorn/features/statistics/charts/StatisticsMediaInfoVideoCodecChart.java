...
public class StatisticsMediaInfoVideoCodecChart extends StatisticsChart {
	public StatisticsMediaInfoVideoCodecChart(CCMovieList ml, StatisticsTypeFilter _source) {
		super(ml, _source);
	}
	...
	private DefaultCategoryDataset getDataSet(CCMovieList movielist, StatisticsTypeFilter source) {
		Map<String, Integer> values = source
				...
				.map(e -> e.mediaInfo().get().getVideoCodec())
				.groupBy(e -> e)
	...
	public String createTitle() {
		return LocaleBundle.getString("StatisticsFrame.charttitles.mediainfo_videocodec"); //$NON-NLS-1$
	}
