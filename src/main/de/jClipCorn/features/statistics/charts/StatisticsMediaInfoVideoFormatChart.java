...
public class StatisticsMediaInfoVideoFormatChart extends StatisticsChart {
	public StatisticsMediaInfoVideoFormatChart(CCMovieList ml, StatisticsTypeFilter _source) {
		super(ml, _source);
	}
	...
	private DefaultCategoryDataset getDataSet(CCMovieList movielist, StatisticsTypeFilter source) {
		Map<String, Integer> values = source
				...
				.map(e -> e.mediaInfo().get().getVideoFormat())
				.groupBy(e -> e)
	...
	public String createTitle() {
		return LocaleBundle.getString("StatisticsFrame.charttitles.mediainfo_videoformat"); //$NON-NLS-1$
	}
