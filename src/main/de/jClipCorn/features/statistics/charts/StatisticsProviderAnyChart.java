...
public class StatisticsProviderAnyChart extends StatisticsChart {
	public StatisticsProviderAnyChart(CCMovieList ml, StatisticsTypeFilter _source) {
		super(ml, _source);
	}
	...
	private DefaultPieDataset getDataSet(CCMovieList movielist, StatisticsTypeFilter source) {
		...
		int[] values = StatisticsHelper.getElementCountForAllProviderAny(it);
	...
	public String createTitle() {
		return LocaleBundle.getString("StatisticsFrame.charttitles.providerAny"); //$NON-NLS-1$
	}
