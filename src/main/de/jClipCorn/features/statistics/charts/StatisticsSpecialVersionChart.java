...
public class StatisticsSpecialVersionChart extends StatisticsChart {
	public StatisticsSpecialVersionChart(CCMovieList ml, StatisticsTypeFilter _source) {
		super(ml, _source);
	}
	...
	private PieDataset getDataSet(CCMovieList movielist, StatisticsTypeFilter source) {
		...
		HashMap<String, Integer> values = StatisticsHelper.getCountForAllSpecialVersions(it);
	...
	public String createTitle() {
		return LocaleBundle.getString("StatisticsFrame.charttitles.specialversion"); //$NON-NLS-1$
	}
