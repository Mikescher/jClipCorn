...
public class StatisticsYearChart extends StatisticsChart {
	...
	private IntervalXYDataset getDataSet(CCMovieList movielist, StatisticsTypeFilter source) {
		CCStream<ICCDatedElement> it = source.iterator(movielist).cast();
	...
	public StatisticsTypeFilter[] supportedTypes() {
		return new StatisticsTypeFilter[]{StatisticsTypeFilter.STF_MOVIES, StatisticsTypeFilter.STF_SEASONS, StatisticsTypeFilter.STF_MOVIES_AND_SEASONS};
	}
}
