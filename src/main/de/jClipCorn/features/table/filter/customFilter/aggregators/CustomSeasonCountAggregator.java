...
public class CustomSeasonCountAggregator extends CustomAggregator {
	...
	public String getName() {
		return LocaleBundle.getFormattedString("FilterTree.Custom.CustomFilterNames.SeasonCounter", asString()); //$NON-NLS-1$
	}

	@Override
	public String getPrecreateName() {
		return LocaleBundle.getDeformattedString("FilterTree.Custom.CustomFilterNames.SeasonCounter").replace("()", "").trim(); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	}
	...
	@Override
	public int getID() {
		return AbstractCustomFilter.CUSTOMFILTERID_SEASONCOUNTER;
	}
