...
import de.jClipCorn.gui.guiComponents.JScrollablePanel;
...
public class AddMovieFrame extends JCCFrame implements ParseResultHandler, UserDataProblemHandler
{
	...
	private void initComponents() {
		...
		scrlData = new JScrollPane();
		pnlData = new JScrollablePanel();
		label15 = new JLabel();
		...
		//======== this ========
		setTitle(LocaleBundle.getString("AddMovieFrame.this.title"));
		setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
		Container contentPane = getContentPane();
		contentPane.setLayout(new FormLayout(
			"$ugap, 0dlu:grow, 10dlu, 130dlu, $ugap",
		...
		//======== pnlLeft ========
		{
			...
			//======== scrlData ========
			{
				scrlData.setHorizontalScrollBarPolicy(ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
				scrlData.setViewportBorder(null);
				scrlData.setBorder(null);
				...
				//======== pnlData ========
				{
					...
					//---- label31 ----
					label31.setText(LocaleBundle.getString("AddMovieFrame.lblSubtitles"));
					...
					//---- lblWatchLater ----
					lblWatchLater.setText(LocaleBundle.getString("AddMovieFrame.lblWatchLater.text"));
					pnlData.add(lblWatchLater, CC.xy(1, 37));
					pnlData.add(cbWatchLater, CC.xywh(3, 37, 3, 1));

					//---- lblWatchNever ----
					lblWatchNever.setText(LocaleBundle.getString("AddMovieFrame.lblWatchNever.text"));
					pnlData.add(lblWatchNever, CC.xy(1, 39));
					pnlData.add(cbWatchNever, CC.xywh(3, 39, 3, 1));
				}
				scrlData.setViewportView(pnlData);
			}
			pnlLeft.add(scrlData, CC.xy(1, 3, CC.FILL, CC.FILL));
		}
		...
		//======== pnlRight ========
		{
			pnlRight.setLayout(new FormLayout(
				"default:grow",
				"default, 10dlu:grow, default"));

			//======== pnlGenres ========
			{
				pnlGenres.setLayout(new FormLayout(
					"default, $lcgap, default:grow",
					"8*(default, $lgap), [50dlu,default]"));
	...
	private JScrollablePanel pnlData;
