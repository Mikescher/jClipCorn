...
public class CoverCropDialog extends JCCFrame
{
	...
	private void initComponents() {
		...
		//======== this ========
		setTitle(LocaleBundle.getString("CoverCropFrame.this.title"));
		...
		contentPane.setLayout(new FormLayout(
			"$ugap, default:grow, $lcgap, [170dlu,pref], $lcgap, 170dlu, $ugap",
		...
		//======== panel1 ========
		{
			...
			//---- btnReset ----
			btnReset.setText(LocaleBundle.getString("CoverCropFrame.btnReset.text"));
			...
			//---- btnAutoCalc ----
			btnAutoCalc.setText(LocaleBundle.getString("CoverCropFrame.btnAutoCalc.text"));
			...
			//---- btnRotateCW ----
			btnRotateCW.setText(LocaleBundle.getString("CoverCropFrame.btnRotateCW.text"));
			...
			//---- btnRotateCCW ----
			btnRotateCCW.setText(LocaleBundle.getString("CoverCropFrame.btnRotateCCW.text"));
			...
			//---- btnFlipX ----
			btnFlipX.setText(LocaleBundle.getString("CoverCropFrame.btnFlipX.text"));
			...
			//---- btnFlipY ----
			btnFlipY.setText(LocaleBundle.getString("CoverCropFrame.btnFlipY.text"));
		...
		//======== panel6 ========
		{
			...
			panel6.setLayout(new FormLayout(
				"$lcgap, default:grow, $lcgap, [30dlu,default], $lcgap",
				"9*($lgap, default), $lgap, default:grow, $lgap, default, $lgap"));

			//---- chckbxLockRatio ----
			chckbxLockRatio.setText(LocaleBundle.getString("CoverCropFrame.btnLockRatio.text"));
			chckbxLockRatio.addItemListener(e -> repaintAll());
			panel6.add(chckbxLockRatio, CC.xywh(2, 2, 3, 1));

			//---- chckbxShowCropOutline ----
			chckbxShowCropOutline.setText(LocaleBundle.getString("CoverCropFrame.btnShowCropOutline.text"));
			...
			chckbxShowImageBorders.setText(LocaleBundle.getString("CoverCropFrame.btnShowImageBorders.text"));
			...
			chckbxShowTransparency.setText(LocaleBundle.getString("CoverCropFrame.btnShowTransparency.text"));
			...
			//---- chckbxSeriesPreview ----
			chckbxSeriesPreview.setText(LocaleBundle.getString("CoverCropFrame.btnShowSeriesPreview.text"));
			chckbxSeriesPreview.addItemListener(e -> repaintAll());
			panel6.add(chckbxSeriesPreview, CC.xywh(2, 10, 3, 1));

			//---- lblPosition ----
			lblPosition.setText(LocaleBundle.getString("CoverCropFrame.lblPosition.text"));
			panel6.add(lblPosition, CC.xy(2, 12));

			//---- lblSize ----
			lblSize.setText(LocaleBundle.getString("CoverCropFrame.lblSize.text"));
			panel6.add(lblSize, CC.xy(2, 14));

			//---- lblRatio ----
			lblRatio.setText(LocaleBundle.getString("CoverCropFrame.lblRatio.text"));
			panel6.add(lblRatio, CC.xy(2, 16));

			//---- lblRatioState ----
			lblRatioState.setText(LocaleBundle.getString("CoverCropFrame.lblOK.textOK"));
			...
			//---- lblMouse ----
			lblMouse.setText(LocaleBundle.getString("CoverCropFrame.lblMouse.text"));
			...
			//======== panel13 ========
			{
				...
				//---- btnCopyParams ----
				btnCopyParams.setText(LocaleBundle.getString("UIGeneric.copy"));
				btnCopyParams.addActionListener(e -> copyParams(e));
				panel13.add(btnCopyParams);

				//---- btnPasteAbs ----
				btnPasteAbs.setText(LocaleBundle.getString("UIGeneric.Paste"));
				btnPasteAbs.addActionListener(e -> pasteParams(e));
				panel13.add(btnPasteAbs);

				//---- btnPasteRel ----
				btnPasteRel.setText(LocaleBundle.getString("CoverCropFrame.PasteRel"));
		...
		//======== panel7 ========
		{
			...
			panel7.setLayout(new FormLayout(
				"$lcgap, default:grow, $lcgap",
				"$lgap, default, $lgap, default:grow, $lgap"));
		...
		//======== panel8 ========
		{
			...
			panel8.setLayout(new FormLayout(
				"2dlu, 2*(default, $lcgap), default:grow, $lcgap, default, 1dlu",
				"$nlgap, default:grow, $lgap, default, $nlgap"));
