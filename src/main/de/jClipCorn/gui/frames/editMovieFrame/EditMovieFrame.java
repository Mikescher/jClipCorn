...
public class EditMovieFrame extends JCCFrame implements ParseResultHandler, UserDataProblemHandler, ImageCropperResultListener
{
	...
	private void initFields() {
		...
		spnYear.setValueOpt(movie.Year.get());
	...
	private void onBtnOK(boolean check) {
		...
		movie.Year.set(spnYear.getValueOpt());
		...
		movie.SpecialVersion.set(CCStringList.create(edSpecialVersion.getValues()));
		movie.AnimeSeason.set(CCStringList.create(edAnimeSeason.getValues()));
		movie.AnimeStudio.set(CCStringList.create(edAnimeStudio.getValues()));
	...
	private void initComponents() {
		...
		//======== this ========
		setTitle(LocaleBundle.getString("EditMovieFrame.this.title"));
		...
		contentPane.setLayout(new FormLayout(
			"$ugap, 0dlu:grow, 10dlu, pref, $ugap",
		...
		//======== pnlLeft ========
		{
			...
			//======== pnlParts ========
			{
				pnlParts.setLayout(new FormLayout(
					"default, $lcgap, 0dlu:grow, 2*($lcgap, default)",
					"6*(default, $lgap), default"));

				//---- label1 ----
				label1.setText(LocaleBundle.getString("AddMovieFrame.lblPart.text"));
				...
				//---- label2 ----
				label2.setText(LocaleBundle.getString("AddMovieFrame.lblPart_1.text"));
				...
				//---- btnClear1 ----
				btnClear1.setText(LocaleBundle.getString("AddMovieFrame.btnClear.text"));
				btnClear1.addActionListener(e -> onClear1());
				pnlParts.add(btnClear1, CC.xy(7, 3));

				//---- label3 ----
				label3.setText(LocaleBundle.getString("AddMovieFrame.lblPart_2.text"));
				...
				//---- btnClear2 ----
				btnClear2.setText(LocaleBundle.getString("AddMovieFrame.btnClear.text"));
				btnClear2.addActionListener(e -> onClear2());
				pnlParts.add(btnClear2, CC.xy(7, 5));

				//---- label5 ----
				label5.setText(LocaleBundle.getString("AddMovieFrame.lblPart_3.text"));
				...
				//---- btnClear3 ----
				btnClear3.setText(LocaleBundle.getString("AddMovieFrame.btnClear.text"));
				btnClear3.addActionListener(e -> onClear3());
				pnlParts.add(btnClear3, CC.xy(7, 7));

				//---- label6 ----
				label6.setText(LocaleBundle.getString("AddMovieFrame.lblPart_4.text"));
				...
				//---- btnClear4 ----
				btnClear4.setText(LocaleBundle.getString("AddMovieFrame.btnClear.text"));
				btnClear4.addActionListener(e -> onClear4());
				pnlParts.add(btnClear4, CC.xy(7, 9));

				//---- label4 ----
				label4.setText(LocaleBundle.getString("AddMovieFrame.lblPart_5.text"));
				...
				//---- btnClear5 ----
				btnClear5.setText(LocaleBundle.getString("AddMovieFrame.btnClear.text"));
				btnClear5.addActionListener(e -> onClear5());
				pnlParts.add(btnClear5, CC.xy(7, 11));

				//---- btnTestParts ----
				btnTestParts.setText(LocaleBundle.getString("EditMovieFrame.btnTestParts.text"));
			...
			//======== pnlData ========
			{
				pnlData.setLayout(new FormLayout(
					"default, $lcgap, 0dlu:grow, $lcgap, [40dlu,default], $lcgap, 16dlu, $lcgap, 25dlu, $lcgap, [30dlu,default]",
					"15*(default, $lgap), 16dlu:grow, 4*($lgap, default)"));

				//---- label15 ----
				label15.setText(LocaleBundle.getString("AddMovieFrame.label_1.text"));
				pnlData.add(label15, CC.xy(1, 1));
				pnlData.add(edTitle, CC.xywh(3, 1, 3, 1));

				//---- label16 ----
				label16.setText(LocaleBundle.getString("AddMovieFrame.lblOnlineID.text"));
				pnlData.add(label16, CC.xy(1, 3));
				pnlData.add(edReference, CC.xywh(3, 3, 3, 1));

				//---- label17 ----
				label17.setText(LocaleBundle.getString("AddMovieFrame.lblZyklus.text"));
				...
				//---- label18 ----
				label18.setText(LocaleBundle.getString("EditSeriesFrame.lblGroups.text"));
				pnlData.add(label18, CC.xy(1, 7));
				pnlData.add(edGroups, CC.xywh(3, 7, 3, 1));

				//---- label19 ----
				label19.setText(LocaleBundle.getString("AddMovieFrame.lblLength.text"));
				...
				btnMediaInfoLen.setToolTipText("MediaInfo");
				...
				//---- label20 ----
				label20.setText(LocaleBundle.getString("AddMovieFrame.lblSprache.text"));
				...
				btnMediaInfoSubs.setToolTipText("MediaInfo");
				...
				//---- label21 ----
				label21.setText(LocaleBundle.getString("AddMovieFrame.lblMediaInfo"));
				...
				btnMediaInfoMain.setToolTipText("MediaInfo");
				btnMediaInfoMain.addActionListener(e -> calculateAndSetMediaInfo());
				pnlData.add(btnMediaInfoMain, CC.xy(7, 15));

				//---- label22 ----
				label22.setText(LocaleBundle.getString("AddMovieFrame.lblEinfgDatum.text"));
				...
				//---- label23 ----
				label23.setText(LocaleBundle.getString("AddMovieFrame.lblOnlinescore.text"));
				pnlData.add(label23, CC.xy(1, 19));
				pnlData.add(spnOnlineScore, CC.xywh(3, 19, 3, 1));

				//---- label24 ----
				label24.setText(LocaleBundle.getString("AddMovieFrame.lblFsk.text"));
				pnlData.add(label24, CC.xy(1, 21));
				pnlData.add(cbxFSK, CC.xywh(3, 21, 3, 1));

				//---- label25 ----
				label25.setText(LocaleBundle.getString("AddMovieFrame.lblFormat.text"));
				pnlData.add(label25, CC.xy(1, 23));
				pnlData.add(cbxFormat, CC.xywh(3, 23, 3, 1));

				//---- label26 ----
				label26.setText(LocaleBundle.getString("AddMovieFrame.lblYear.text"));
				pnlData.add(label26, CC.xy(1, 25));
				pnlData.add(spnYear, CC.xywh(3, 25, 3, 1));

				//---- label27 ----
				label27.setText(LocaleBundle.getString("AddMovieFrame.lblGre.text"));
				...
				//---- label28 ----
				label28.setText(LocaleBundle.getString("EditSeriesFrame.lblScore.text"));
				pnlData.add(label28, CC.xy(1, 29));
				pnlData.add(cbxScore, CC.xywh(3, 29, 3, 1));

				//---- label30 ----
				label30.setText(LocaleBundle.getString("EditMovieFrame.lblScoreComment"));
				...
				//---- label31 ----
				label31.setText(LocaleBundle.getString("EditSeriesFrame.lblTags.text"));
		...
		//======== pnlRight ========
		{
			pnlRight.setLayout(new FormLayout(
				"default:grow",
				"default:grow, 10dlu, pref"));

			//======== pnlGenres ========
			{
				pnlGenres.setLayout(new FormLayout(
					"default, $lcgap, default:grow",
					"7*(default, $lgap), default, $pgap, [50dlu,default], $pgap, [65dlu,default]:grow"));

				//---- label7 ----
				label7.setText(LocaleBundle.getString("AddMovieFrame.lblGenre.text"));
				pnlGenres.add(label7, CC.xy(1, 1));
				pnlGenres.add(cbxGenre0, CC.xy(3, 1));

				//---- label8 ----
				label8.setText(LocaleBundle.getString("AddMovieFrame.lblGenre_1.text"));
				pnlGenres.add(label8, CC.xy(1, 3));
				pnlGenres.add(cbxGenre1, CC.xy(3, 3));

				//---- label9 ----
				label9.setText(LocaleBundle.getString("AddMovieFrame.lblGenre_2.text"));
				pnlGenres.add(label9, CC.xy(1, 5));
				pnlGenres.add(cbxGenre2, CC.xy(3, 5));

				//---- label10 ----
				label10.setText(LocaleBundle.getString("AddMovieFrame.lblGenre_3.text"));
				pnlGenres.add(label10, CC.xy(1, 7));
				pnlGenres.add(cbxGenre3, CC.xy(3, 7));

				//---- label11 ----
				label11.setText(LocaleBundle.getString("AddMovieFrame.lblGenre_4.text"));
				pnlGenres.add(label11, CC.xy(1, 9));
				pnlGenres.add(cbxGenre4, CC.xy(3, 9));

				//---- label12 ----
				label12.setText(LocaleBundle.getString("AddMovieFrame.lblGenre_5.text"));
				pnlGenres.add(label12, CC.xy(1, 11));
				pnlGenres.add(cbxGenre5, CC.xy(3, 11));

				//---- label13 ----
				label13.setText(LocaleBundle.getString("AddMovieFrame.lblGenre_6.text"));
				pnlGenres.add(label13, CC.xy(1, 13));
				pnlGenres.add(cbxGenre6, CC.xy(3, 13));

				//---- label14 ----
				label14.setText(LocaleBundle.getString("AddMovieFrame.lblGenre_7.text"));
				pnlGenres.add(label14, CC.xy(1, 15));
				pnlGenres.add(cbxGenre7, CC.xy(3, 15));

				//---- btnParseIMDB ----
				btnParseIMDB.setText(LocaleBundle.getString("AddMovieFrame.btnParseIMDB.text"));
				...
				//---- label32 ----
				label32.setText(LocaleBundle.getString("EditSeriesFrame.lblHistory.text"));
