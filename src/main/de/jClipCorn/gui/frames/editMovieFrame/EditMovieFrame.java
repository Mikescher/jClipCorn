        ...
        //======== pnlLeft ========
        {
            ...
            //======== pnlData ========
            {
                pnlData.setLayout(new FormLayout(
                    ...
                    "15*(default, $lgap), 16dlu:grow, 4*($lgap, default)")); //$NON-NLS-1$
                ...
                //---- lblSpecialVersion ----
                lblSpecialVersion.setText(LocaleBundle.getString("EditMovieFrame.lblSpecialVersion.text")); //$NON-NLS-1$
                pnlData.add(lblSpecialVersion, CC.xy(1, 35));
                pnlData.add(edSpecialVersion, CC.xywh(3, 35, 3, 1));

                //---- lblAnimeSeason ----
                lblAnimeSeason.setText(LocaleBundle.getString("EditMovieFrame.lblAnimeSeason.text")); //$NON-NLS-1$
                pnlData.add(lblAnimeSeason, CC.xy(1, 37));
                pnlData.add(edAnimeSeason, CC.xywh(3, 37, 3, 1));

                //---- lblAnimeStudio ----
                lblAnimeStudio.setText(LocaleBundle.getString("EditMovieFrame.lblAnimeStudio.text")); //$NON-NLS-1$
