...
public class EditSeriesFrame extends JCCFrame
{
	...
	private void initComponents() {
		...
		//======== this ========
		setTitle(LocaleBundle.getString("EditSeriesFrame.this.title"));
		...
		//======== pnlEditSeries ========
		{
			...
			pnlEditSeries.setLayout(new FormLayout(
				...
				"$lgap, default, $lgap, pref, $lgap, default:grow, $lgap, default, $lgap"));

			//======== panel3 ========
			{
				panel3.setLayout(new FormLayout(
					"default, 12dlu, default, $lcgap, 0dlu:grow",
					"8*(default, $lgap), default:grow"));
				panel3.add(edSeriesCvrControl, CC.xywh(1, 1, 1, 17));

				//---- label1 ----
				label1.setText(LocaleBundle.getString("AddMovieFrame.lblGenre.text"));
				panel3.add(label1, CC.xy(3, 1));
				panel3.add(cbxSeriesGenre_0, CC.xy(5, 1));

				//---- label2 ----
				label2.setText(LocaleBundle.getString("AddMovieFrame.lblGenre_1.text"));
				panel3.add(label2, CC.xy(3, 3));
				panel3.add(cbxSeriesGenre_1, CC.xy(5, 3));

				//---- label3 ----
				label3.setText(LocaleBundle.getString("AddMovieFrame.lblGenre_2.text"));
				panel3.add(label3, CC.xy(3, 5));
				panel3.add(cbxSeriesGenre_2, CC.xy(5, 5));

				//---- label4 ----
				label4.setText(LocaleBundle.getString("AddMovieFrame.lblGenre_3.text"));
				panel3.add(label4, CC.xy(3, 7));
				panel3.add(cbxSeriesGenre_3, CC.xy(5, 7));

				//---- label5 ----
				label5.setText(LocaleBundle.getString("AddMovieFrame.lblGenre_4.text"));
				panel3.add(label5, CC.xy(3, 9));
				panel3.add(cbxSeriesGenre_4, CC.xy(5, 9));

				//---- label6 ----
				label6.setText(LocaleBundle.getString("AddMovieFrame.lblGenre_5.text"));
				panel3.add(label6, CC.xy(3, 11));
				panel3.add(cbxSeriesGenre_5, CC.xy(5, 11));

				//---- label7 ----
				label7.setText(LocaleBundle.getString("AddMovieFrame.lblGenre_6.text"));
				panel3.add(label7, CC.xy(3, 13));
				panel3.add(cbxSeriesGenre_6, CC.xy(5, 13));

				//---- label8 ----
				label8.setText(LocaleBundle.getString("AddMovieFrame.lblGenre_7.text"));
			...
			//======== panel5 ========
			{
				...
				//======== panel6 ========
				{
					...
					//---- btnParseOnline ----
					btnParseOnline.setText(LocaleBundle.getString("EditSeriesFrame.btnOnline"));
				...
				//---- label10 ----
				label10.setText(LocaleBundle.getString("AddMovieFrame.lblOnlinescore.text"));
				panel5.add(label10, CC.xy(1, 3));
				panel5.add(spnSeriesOnlineScore, CC.xy(3, 3));

				//---- label11 ----
				label11.setText(LocaleBundle.getString("AddMovieFrame.lblFsk.text"));
				panel5.add(label11, CC.xy(1, 5));
				panel5.add(cbxSeriesFSK, CC.xy(3, 5));

				//---- label12 ----
				label12.setText(LocaleBundle.getString("EditSeriesFrame.lblScore.text"));
				panel5.add(label12, CC.xy(1, 7));
				panel5.add(cbxSeriesScore, CC.xy(3, 7));

				//---- label33 ----
				label33.setText(LocaleBundle.getString("EditSeriesFrame.lblComment"));
				...
				//---- label13 ----
				label13.setText(LocaleBundle.getString("AddMovieFrame.lblOnlineID.text"));
				...
				//---- label15 ----
				label15.setText(LocaleBundle.getString("EditSeriesFrame.lblTags.text"));
			...
			//======== panel8 ========
			{
				panel8.setLayout(new FormLayout(
					"0dlu:grow, $lcgap, default",
					"6*(default, $lgap), 0dlu:grow"));
				...
				//---- btnAddEmptySeason ----
				btnAddEmptySeason.setText(LocaleBundle.getString("EditSeriesFrame.btnAddEmptySeason.text"));
				btnAddEmptySeason.addActionListener(e -> addEmptySeason());
				panel8.add(btnAddEmptySeason, CC.xy(3, 1));

				//---- btnAddSeason ----
				btnAddSeason.setText(LocaleBundle.getString("EditSeriesFrame.btnAddSeason.text"));
				btnAddSeason.addActionListener(e -> addSeason());
				panel8.add(btnAddSeason, CC.xy(3, 3));

				//---- btnEditSerinBatch ----
				btnEditSerinBatch.setText(LocaleBundle.getString("EditSeriesFrame.btnBatchEdit.text"));
				btnEditSerinBatch.addActionListener(e -> onEditAllSeasonsInBatch());
				panel8.add(btnEditSerinBatch, CC.xy(3, 5));

				//---- btnEditSelSerInBatch ----
				btnEditSelSerInBatch.setText(LocaleBundle.getString("EditSeriesFrame.btnBatchEditSelection.text"));
				btnEditSelSerInBatch.addActionListener(e -> batchEditSelectedSeasons());
				panel8.add(btnEditSelSerInBatch, CC.xy(3, 7));

				//---- btnRemoveSeason ----
				btnRemoveSeason.setText(LocaleBundle.getString("EditSeriesFrame.btnRemoveSeason.text"));
			...
			//======== panel4 ========
			{
				...
				//---- btnSeriesOk ----
				btnSeriesOk.setText(LocaleBundle.getString("UIGeneric.btnOK.text"));
				btnSeriesOk.addActionListener(e -> onSeriesOkay());
				panel4.add(btnSeriesOk);

				//---- btnOkClose ----
				btnOkClose.setText(LocaleBundle.getString("UIGeneric.btnOK_and_Close.text"));
		...
		//======== pnlEditSeason ========
		{
			...
			//---- label17 ----
			label17.setText(LocaleBundle.getString("EditSeriesFrame.label17.text"));
			pnlEditSeason.add(label17, CC.xy(2, 4));
			pnlEditSeason.add(edSeasonTitle, CC.xywh(4, 4, 5, 1));

			//---- label18 ----
			label18.setText(LocaleBundle.getString("AddMovieFrame.lblYear.text"));
			pnlEditSeason.add(label18, CC.xy(2, 6));
			pnlEditSeason.add(spnSeasonYear, CC.xywh(4, 6, 5, 1));

			//---- label16 ----
			label16.setText(LocaleBundle.getString("EditSeriesFrame.label16.text"));
			pnlEditSeason.add(label16, CC.xy(2, 8));
			pnlEditSeason.add(cbxSeasonScore, CC.xywh(4, 8, 5, 1));

			//---- label34 ----
			label34.setText(LocaleBundle.getString("EditSeriesFrame.label34.text"));
			...
			//======== panel9 ========
			{
				...
				//---- button12 ----
				button12.setText(LocaleBundle.getString("UIGeneric.btnOK.text"));
		...
		//======== pnlEditEpisode ========
		{
			...
			pnlEditEpisode.setLayout(new FormLayout(
				"$lcgap, default, $lcgap, 0dlu:grow, $lcgap, 14dlu, $lcgap, [25dlu,pref], $lcgap",
				"3*($lgap, pref), 4*($lgap, 14dlu), $lgap, pref, 2*($lgap, 14dlu), $lgap, default, $lgap, 64dlu, 2*($lgap, pref), $lgap, 0dlu:grow, $lgap, pref, $lgap"));

			//---- label19 ----
			label19.setText(LocaleBundle.getString("AddMovieFrame.label_1.text"));
			pnlEditEpisode.add(label19, CC.xy(2, 2));
			pnlEditEpisode.add(edEpisodeTitle, CC.xywh(4, 2, 5, 1));

			//---- label20 ----
			label20.setText(LocaleBundle.getString("AddEpisodeFrame.lblEpisode.text"));
			...
			//---- label21 ----
			label21.setText(LocaleBundle.getString("AddMovieFrame.lblFormat.text"));
			pnlEditEpisode.add(label21, CC.xy(2, 6));
			pnlEditEpisode.add(cbxEpisodeFormat, CC.xywh(4, 6, 5, 1));

			//---- label22 ----
			label22.setText(LocaleBundle.getString("AddMovieFrame.lblMediaInfo"));
			...
			btnEpisodeMediaInfoLang.setToolTipText("MediaInfo");
			...
			btnEpisodeMediaInfoLength.setToolTipText("MediaInfo");
			...
			//---- label25 ----
			label25.setText(LocaleBundle.getString("AddMovieFrame.lblGre.text"));
			...
			//---- label28 ----
			label28.setText(LocaleBundle.getString("AddMovieFrame.lblEinfgDatum.text"));
			pnlEditEpisode.add(label28, CC.xy(2, 18));
			pnlEditEpisode.add(spnEpisodeAdded, CC.xy(4, 18));

			//---- button15 ----
			button15.setText(LocaleBundle.getString("AddEpisodeFrame.btnToday.text"));
			button15.addActionListener(e -> onSetEpisodeAddedToToday());
			pnlEditEpisode.add(button15, CC.xywh(6, 18, 3, 1));

			//---- label29 ----
			label29.setText(LocaleBundle.getString("AddEpisodeFrame.lblPart.text"));
			...
			//---- label32 ----
			label32.setText(LocaleBundle.getString("EditSeriesFrame.label32.text"));
			pnlEditEpisode.add(label32, CC.xy(2, 22));
			pnlEditEpisode.add(cbxEpisodeScore, CC.xywh(4, 22, 5, 1));

			//---- label35 ----
			label35.setText(LocaleBundle.getString("EditSeriesFrame.label35.text"));
			...
			//---- label30 ----
			label30.setText(LocaleBundle.getString("EditSeriesFrame.lblTags.text"));
			pnlEditEpisode.add(label30, CC.xy(2, 26));
			pnlEditEpisode.add(edEpisodeTags, CC.xywh(4, 26, 5, 1));

			//---- label31 ----
			label31.setText(LocaleBundle.getString("EditSeriesFrame.lblHistory.text"));
			...
			//======== panel10 ========
			{
				...
				//---- button17 ----
				button17.setText(LocaleBundle.getString("UIGeneric.btnOK.text"));
