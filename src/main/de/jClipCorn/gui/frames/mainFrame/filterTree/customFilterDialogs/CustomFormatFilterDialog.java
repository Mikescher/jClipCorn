...
public class CustomFormatFilterDialog extends CustomFilterDialog {
	...
	public CustomFormatFilterDialog(CustomFormatFilter ft, FinishListener fl, Component parent) {
		super(ft, fl);
		initGUI();
		
		cbxMiddle.setModel(new DefaultComboBoxModel<>(CCMovieFormat.getList()));
	...
	@Override
	protected CustomFormatFilter getFilter() {
		return (CustomFormatFilter) super.getFilter();
	}
