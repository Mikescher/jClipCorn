...
public class MoveSeriesDialog extends JCCDialog
{
	...
	{
		ccprops().PROP_FSIZE_MOVESERIESFRAME.applyOrSkip(this);
	...
	private void initComponents() {
		...
		//======== this ========
		setTitle(LocaleBundle.getString("MoveSeriesFrame.this.title"));
		...
		//======== panel1 ========
		{
			panel1.setLayout(new FormLayout(
				...
				"6*(default, $lgap), 0dlu:grow, $lgap, default, $lgap, pref, $lgap"));
