...
public class OmniParserFrame extends JCCDialog
{
	...
	private void initComponents() {
		...
		//======== this ========
		setTitle(LocaleBundle.getString("OmniParserFrame.this.title"));
		setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
		Container contentPane = getContentPane();
		contentPane.setLayout(new FormLayout(
			"$ugap, 0dlu:grow(0.3), $lcgap, 0dlu:grow(0.4), $lcgap, 0dlu:grow(0.1), $lcgap, pref, $ugap",
			"$ugap, default, 2*($lgap, 0dlu:grow), $lgap, default, $ugap"));
		...
		//======== panel1 ========
		{
			...
			//---- btnLoadFromFiles ----
			btnLoadFromFiles.setText(LocaleBundle.getString("OmniParserFrame.btnLoadFromFiles.text"));
			btnLoadFromFiles.addActionListener(e -> onLoadFromFiles(e));
			panel1.add(btnLoadFromFiles, CC.xy(1, 1));

			//---- btnLoadFromFolder ----
			btnLoadFromFolder.setText(LocaleBundle.getString("OmniParserFrame.btnLoadFromFolder.text"));
			btnLoadFromFolder.addActionListener(e -> onLoadFromFolder(e));
			panel1.add(btnLoadFromFolder, CC.xy(3, 1));

			//---- btnLoadFromClipboard ----
			btnLoadFromClipboard.setText(LocaleBundle.getString("OmniParserFrame.btnLoadFromClipboard.text"));
		...
		//======== panel3 ========
		{
			...
			//---- label1 ----
			label1.setText(LocaleBundle.getString("OmniParserFrame.labelStep1.text"));
		...
		//======== panel4 ========
		{
			...
			//---- label2 ----
			label2.setText(LocaleBundle.getString("OmniParserFrame.labelStep2.text"));
		...
		//======== panel5 ========
		{
			...
			//---- label3 ----
			label3.setText(LocaleBundle.getString("OmniParserFrame.labelStep3.text"));
		...
		//======== panel6 ========
		{
			...
			//---- label4 ----
			label4.setText(LocaleBundle.getString("OmniParserFrame.labelStep4.text"));
		...
		//======== panel7 ========
		{
			panel7.setBorder(new TitledBorder(LocaleBundle.getString("OmniParserFrame.labelOptions.text")));
		...
		//======== panel2 ========
		{
			panel2.setLayout(new FormLayout(
				"0dlu:grow, default, $lcgap, default, 0dlu:grow",
				"default"));
