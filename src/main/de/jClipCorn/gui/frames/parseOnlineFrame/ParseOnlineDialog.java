...
public class ParseOnlineDialog extends JCCDialog
{
	...
	private void initComponents() {
		...
		//======== this ========
		setTitle(LocaleBundle.getString("parseImDBFrame.this.title"));
		...
		//======== panel1 ========
		{
			...
			//---- btnParse ----
			btnParse.setText(LocaleBundle.getString("parseImDBFrame.btnParse.text"));
			btnParse.addActionListener(e -> startParse());
			panel1.add(btnParse, CC.xy(3, 1));

			//---- btnExtendedParse ----
			btnExtendedParse.setText(LocaleBundle.getString("parseImDBFrame.btnParseExtended.text"));
		...
		//======== panel2 ========
		{
			...
			panel2.setLayout(new FormLayout(
				"$lcgap, 175dlu, $lcgap, 0dlu:grow, $lcgap",
				"$lgap, default:grow, $lgap, default, $lgap"));
			...
			//======== panel3 ========
			{
				...
				panel3.setLayout(new FormLayout(
					"2*($lcgap, default), $lcgap, 240px, 3*($lcgap, default), $lcgap, 0dlu:grow, $lcgap",
					"10*($lgap, default), $lgap, default:grow, 3*($lgap, default), $lgap, $pgap, $lgap, default, $lgap"));
				...
				//---- label3 ----
				label3.setText(LocaleBundle.getString("AddMovieFrame.lblOnlinescore.text"));
				...
				//---- label4 ----
				label4.setText(LocaleBundle.getString("AddMovieFrame.lblLength.text"));
				...
				//---- label5 ----
				label5.setText(LocaleBundle.getString("AddMovieFrame.lblFsk.text"));
				...
				//---- label6 ----
				label6.setText(LocaleBundle.getString("AddMovieFrame.lblCover.text"));
				panel3.add(label6, CC.xy(4, 12));

				//---- imgCover ----
				imgCover.setText("text");
				...
				//---- label15 ----
				label15.setText(LocaleBundle.getString("ParseOnlineDialog.lblAnimeSeason.text"));
				...
				//---- label16 ----
				label16.setText(LocaleBundle.getString("ParseOnlineDialog.lblAnimeStudio.text"));
				...
				//---- btnFSKAll ----
				btnFSKAll.setText(LocaleBundle.getString("parseImDBFrame.btnFSKAll.text"));
				btnFSKAll.addActionListener(e -> showAllRatingsDialog());
				panel3.add(btnFSKAll, CC.xy(14, 28));

				//---- btnApply ----
				btnApply.setText(LocaleBundle.getString("UIGeneric.btnApply.text"));
