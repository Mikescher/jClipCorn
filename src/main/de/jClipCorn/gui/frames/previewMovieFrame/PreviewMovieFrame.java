        ...
        //======== tabbedPane1 ========
        {
            ...
            //======== pnlTabMain ========
            {
                pnlTabMain.setLayout(new FormLayout(
                    "3*($lcgap, default), $lcgap, 0dlu:grow, $lcgap, 80dlu, $lcgap", //$NON-NLS-1$
                    "18*($lgap, default), $lgap, default:grow")); //$NON-NLS-1$
                ...
                //---- label33 ----
                label33.setText(LocaleBundle.getString("PreviewMovieFrame.labelSpecialVersion.text")); //$NON-NLS-1$
                pnlTabMain.add(label33, CC.xy(2, 30));

                //---- lblSpecialVersion ----
                lblSpecialVersion.setText("<dynamic>"); //$NON-NLS-1$
                pnlTabMain.add(lblSpecialVersion, CC.xy(6, 30));

                //---- label34 ----
                label34.setText(LocaleBundle.getString("PreviewMovieFrame.labelAnimeSeason.text")); //$NON-NLS-1$
                pnlTabMain.add(label34, CC.xy(2, 32));

                //---- lblAnimeSeason ----
                lblAnimeSeason.setText("<dynamic>"); //$NON-NLS-1$
                pnlTabMain.add(lblAnimeSeason, CC.xy(6, 32));

                //---- label35 ----
                label35.setText(LocaleBundle.getString("PreviewMovieFrame.labelAnimeStudio.text")); //$NON-NLS-1$
                pnlTabMain.add(label35, CC.xy(2, 34));

                //---- lblAnimeStudio ----
                lblAnimeStudio.setText("<dynamic>"); //$NON-NLS-1$
