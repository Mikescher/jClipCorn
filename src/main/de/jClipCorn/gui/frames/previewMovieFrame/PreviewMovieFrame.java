...
public class PreviewMovieFrame extends JCCFrame implements UpdateCallbackListener
{
	...
	private void updateData() {
		...
		lblSpecialVersion.setText(movie.SpecialVersion.get().ccstream().stringjoin(", "));
	...
	private void initComponents() {
		...
		//======== pnlTop ========
		{
			pnlTop.setLayout(new FormLayout(
				"63dlu, $lcgap, 0dlu:grow, 2*($lcgap, 30dlu)",
				"default"));
			pnlTop.add(lblViewed, CC.xy(1, 1, CC.FILL, CC.FILL));

			//---- lblHeaderTitle ----
			lblHeaderTitle.setText("<dynamic>");
		...
		//======== tabbedPane1 ========
		{
			...
			//======== pnlTabMain ========
			{
				pnlTabMain.setLayout(new FormLayout(
					"3*($lcgap, default), $lcgap, 0dlu:grow, $lcgap, 80dlu, $lcgap",
					"18*($lgap, default), $lgap, default:grow"));
				...
				//---- label2 ----
				label2.setText(LocaleBundle.getString("AddMovieFrame.lblZyklus.text"));
				pnlTabMain.add(label2, CC.xy(2, 4));

				//---- lblZyklus ----
				lblZyklus.setText("<dynamic>");
				pnlTabMain.add(lblZyklus, CC.xywh(6, 4, 3, 1));

				//---- label3 ----
				label3.setText(LocaleBundle.getString("AddMovieFrame.lblQuality.text"));
				pnlTabMain.add(label3, CC.xy(2, 6));
				pnlTabMain.add(lblQualityIcon, CC.xy(4, 6, CC.FILL, CC.FILL));

				//---- lblQuality ----
				lblQuality.setText("<dynamic>");
				pnlTabMain.add(lblQuality, CC.xy(6, 6));

				//---- label4 ----
				label4.setText(LocaleBundle.getString("AddMovieFrame.lblOnlinescore.text"));
				...
				//---- label7 ----
				label7.setText(LocaleBundle.getString("PreviewMovieFrame.lblSubs"));
				...
				//---- lblLength ----
				lblLength.setText("<dynamic>");
				pnlTabMain.add(lblLength, CC.xy(6, 14));

				//---- label19 ----
				label19.setText(LocaleBundle.getString("AddMovieFrame.lblEinfgDatum.text"));
				pnlTabMain.add(label19, CC.xy(2, 16));

				//---- lblAdded ----
				lblAdded.setText("<dynamic>");
				pnlTabMain.add(lblAdded, CC.xy(6, 16));

				//---- label8 ----
				label8.setText(LocaleBundle.getString("AddMovieFrame.lblFsk.text"));
				pnlTabMain.add(label8, CC.xy(2, 18));
				pnlTabMain.add(lblFSKIcon, CC.xy(4, 18, CC.FILL, CC.FILL));

				//---- lblFSK ----
				lblFSK.setText("<dynamic>");
				pnlTabMain.add(lblFSK, CC.xy(6, 18));

				//---- label9 ----
				label9.setText(LocaleBundle.getString("AddMovieFrame.lblFormat.text"));
				pnlTabMain.add(label9, CC.xy(2, 20));
				pnlTabMain.add(lblFormatIcon, CC.xy(4, 20, CC.FILL, CC.FILL));

				//---- lblFormat ----
				lblFormat.setText("<dynamic>");
				pnlTabMain.add(lblFormat, CC.xy(6, 20));

				//---- label10 ----
				label10.setText(LocaleBundle.getString("AddMovieFrame.lblYear.text"));
				pnlTabMain.add(label10, CC.xy(2, 22));

				//---- lblYear ----
				lblYear.setText("<dynamic>");
				pnlTabMain.add(lblYear, CC.xy(6, 22));

				//---- label11 ----
				label11.setText(LocaleBundle.getString("AddMovieFrame.lblGre.text"));
				pnlTabMain.add(label11, CC.xy(2, 24));

				//---- lblSize ----
				lblSize.setText("<dynamic>");
				pnlTabMain.add(lblSize, CC.xy(6, 24));

				//---- label12 ----
				label12.setText(LocaleBundle.getString("PreviewMovieFrame.btnScore.text"));
				pnlTabMain.add(label12, CC.xy(2, 26, CC.DEFAULT, CC.TOP));
				pnlTabMain.add(lblUserScoreIcon, CC.xy(4, 26, CC.FILL, CC.TOP));

				//---- lblUserScore ----
				lblUserScore.setText("<dynamic>");
				...
				//---- label13 ----
				label13.setText(LocaleBundle.getString("EditSeriesFrame.lblTags.text"));
				pnlTabMain.add(label13, CC.xy(2, 28));
				pnlTabMain.add(lblTags, CC.xy(6, 28, CC.DEFAULT, CC.FILL));

				//---- label33 ----
				label33.setText(LocaleBundle.getString("PreviewMovieFrame.labelSpecialVersion.text"));
				pnlTabMain.add(label33, CC.xy(2, 30));

				//---- lblSpecialVersion ----
				lblSpecialVersion.setText("<dynamic>");
				pnlTabMain.add(lblSpecialVersion, CC.xy(6, 30));

				//---- label34 ----
				label34.setText(LocaleBundle.getString("PreviewMovieFrame.labelAnimeSeason.text"));
				pnlTabMain.add(label34, CC.xy(2, 32));

				//---- lblAnimeSeason ----
				lblAnimeSeason.setText("<dynamic>");
				pnlTabMain.add(lblAnimeSeason, CC.xy(6, 32));

				//---- label35 ----
				label35.setText(LocaleBundle.getString("PreviewMovieFrame.labelAnimeStudio.text"));
				pnlTabMain.add(label35, CC.xy(2, 34));

				//---- lblAnimeStudio ----
				lblAnimeStudio.setText("<dynamic>");
				pnlTabMain.add(lblAnimeStudio, CC.xy(6, 34));

				//======== panel6 ========
				{
					panel6.setLayout(new FormLayout(
						"0dlu:grow, 2*($lcgap, 1dlu:grow)",
						"default, $lgap, default:grow"));

					//---- label14 ----
					label14.setText(LocaleBundle.getString("EditSeriesFrame.lblGroups.text"));
					panel6.add(label14, CC.xy(1, 1));

					//---- label15 ----
					label15.setText(LocaleBundle.getString("AddMovieFrame.lblGenre.text"));
					panel6.add(label15, CC.xy(3, 1));

					//---- label16 ----
					label16.setText(LocaleBundle.getString("EditSeriesFrame.lblHistory.text"));
				...
				pnlTabMain.add(panel6, CC.xywh(2, 36, 9, 1, CC.FILL, CC.FILL));
			}
			tabbedPane1.addTab(LocaleBundle.getString("PreviewMovieFrame.TabGeneral"), pnlTabMain);
			...
			//======== pnlTabMediaInfo ========
			{
				...
				//======== panel7 ========
				{
					panel7.setBorder(new TitledBorder(LocaleBundle.getString("EditMediaInfoDialog.header1")));
					panel7.setLayout(new FormLayout(
						"$lcgap, pref, $lcgap, default:grow, $lcgap",
						"5*($lgap, default), $lgap"));

					//---- label17 ----
					label17.setText(LocaleBundle.getString("EditMediaInfoDialog.CDate"));
					panel7.add(label17, CC.xy(2, 2));
					panel7.add(edMI_CDate, CC.xy(4, 2));

					//---- label18 ----
					label18.setText(LocaleBundle.getString("EditMediaInfoDialog.MDate"));
					panel7.add(label18, CC.xy(2, 4));
					panel7.add(edMI_MDate, CC.xy(4, 4));

					//---- label20 ----
					label20.setText(LocaleBundle.getString("EditMediaInfoDialog.Filesize"));
					panel7.add(label20, CC.xy(2, 6));
					panel7.add(edMI_Filesize, CC.xy(4, 6));

					//---- label21 ----
					label21.setText(LocaleBundle.getString("EditMediaInfoDialog.Duration"));
					panel7.add(label21, CC.xy(2, 8));
					panel7.add(edMI_Duration, CC.xy(4, 8));

					//---- label22 ----
					label22.setText(LocaleBundle.getString("EditMediaInfoDialog.Bitrate"));
				...
				//======== panel8 ========
				{
					panel8.setBorder(new TitledBorder(LocaleBundle.getString("EditMediaInfoDialog.header2")));
					panel8.setLayout(new FormLayout(
						"$lcgap, default, $lcgap, default:grow, $lcgap",
						"6*($lgap, default), $lgap"));

					//---- label23 ----
					label23.setText(LocaleBundle.getString("EditMediaInfoDialog.Format"));
					panel8.add(label23, CC.xy(2, 2));
					panel8.add(edMI_VideoFormat, CC.xy(4, 2));

					//---- label24 ----
					label24.setText(LocaleBundle.getString("EditMediaInfoDialog.Resolution"));
					panel8.add(label24, CC.xy(2, 4));
					panel8.add(edMI_VideoResolution, CC.xy(4, 4));

					//---- label25 ----
					label25.setText(LocaleBundle.getString("EditMediaInfoDialog.Framerate"));
					panel8.add(label25, CC.xy(2, 6));
					panel8.add(edMI_VideoFramerate, CC.xy(4, 6));

					//---- label26 ----
					label26.setText(LocaleBundle.getString("EditMediaInfoDialog.Bitdepth"));
					panel8.add(label26, CC.xy(2, 8));
					panel8.add(edMI_VideoBitdepth, CC.xy(4, 8));

					//---- label27 ----
					label27.setText(LocaleBundle.getString("EditMediaInfoDialog.Framecount"));
					panel8.add(label27, CC.xy(2, 10));
					panel8.add(edMI_VideoFramecount, CC.xy(4, 10));

					//---- label28 ----
					label28.setText(LocaleBundle.getString("EditMediaInfoDialog.Codec"));
				...
				//======== panel9 ========
				{
					panel9.setBorder(new TitledBorder(LocaleBundle.getString("EditMediaInfoDialog.header3")));
					panel9.setLayout(new FormLayout(
						"$lcgap, default, $lcgap, default:grow, $lcgap",
						"4*($lgap, default), $lgap"));

					//---- label29 ----
					label29.setText(LocaleBundle.getString("EditMediaInfoDialog.Format"));
					panel9.add(label29, CC.xy(2, 2));
					panel9.add(edMI_AudioFormat, CC.xy(4, 2));

					//---- label30 ----
					label30.setText(LocaleBundle.getString("EditMediaInfoDialog.Channels"));
					panel9.add(label30, CC.xy(2, 4));
					panel9.add(edMI_AudioChannels, CC.xy(4, 4));

					//---- label31 ----
					label31.setText(LocaleBundle.getString("EditMediaInfoDialog.Codec"));
					panel9.add(label31, CC.xy(2, 6));
					panel9.add(edMI_AudioCodec, CC.xy(4, 6));

					//---- label32 ----
					label32.setText(LocaleBundle.getString("EditMediaInfoDialog.Samplerate"));
			...
			tabbedPane1.addTab(LocaleBundle.getString("PreviewMovieFrame.TabMediaInfo"), pnlTabMediaInfo);

			//======== pnlTabPaths ========
			{
				pnlTabPaths.setLayout(new FormLayout(
					"$lcgap, default:grow, 2*($lcgap, 16dlu), $lcgap",
					"6*($lgap, default), $lgap"));
			...
			tabbedPane1.addTab(LocaleBundle.getString("PreviewMovieFrame.TabPaths"), pnlTabPaths);

			//======== pnlTabHistory ========
			{
				pnlTabHistory.setLayout(new FormLayout(
					"$lcgap, default:grow, $lcgap",
					"2*($lgap, 0dlu:grow), $lgap, default, $lgap"));
				...
				//---- btnQueryHistory ----
				btnQueryHistory.setText(LocaleBundle.getString("PreviewMovieFrame.btnQuery"));
				btnQueryHistory.addActionListener(e -> queryHistory());
				pnlTabHistory.add(btnQueryHistory, CC.xy(2, 6, CC.RIGHT, CC.DEFAULT));
			}
			tabbedPane1.addTab(LocaleBundle.getString("PreviewMovieFrame.TabHistory"), pnlTabHistory);
		}
