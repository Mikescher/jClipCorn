...
public class PreviewSeriesFrame extends JCCFrame implements UpdateCallbackListener, ActionCallbackListener, IActionRootFrame
{
	...
	private void initComponents() {
		...
		contentPane.setLayout(new FormLayout(
			"$ugap, 182px, $lcgap, default:grow, $ugap",
			"$ugap, default, $lgap, default:grow, $ugap"));

		//======== pnlTop ========
		{
			pnlTop.setLayout(new FormLayout(
				"182px, $lcgap, 0dlu:grow, $lcgap, [50dlu,pref], $lcgap, 182px",
				"default, pref"));
			...
			//======== pnlTopLeft ========
			{
				...
				btnPlayNext.setRealText(LocaleBundle.getString("PreviewSeriesFrame.btnPlayNext.caption"));
				...
				//---- btnVLCRobot ----
				btnVLCRobot.setText(LocaleBundle.getString("PreviewSeriesFrame.btnPlayRobot.caption"));
		...
		//======== pnlInfo ========
		{
			pnlInfo.setLayout(new FormLayout(
				...
				"default, $lgap, default, $ugap, 4*(default, $lgap), 2*(pref, $lgap), 2*(default, $lgap), 5*(pref, $lgap), default:grow, $lgap, pref"));
			...
			//---- label1 ----
			label1.setText(LocaleBundle.getString("PreviewSeriesFrame.lblLength.text"));
			...
			//---- label2 ----
			label2.setText(LocaleBundle.getString("PreviewSeriesFrame.lblSize.text"));
			...
			//---- label4 ----
			label4.setText(LocaleBundle.getString("PreviewSeriesFrame.lblScore.text"));
			...
			//---- label7 ----
			label7.setText(LocaleBundle.getString("PreviewSeriesFrame.lblLanguage.text"));
			...
			//---- label10 ----
			label10.setText(LocaleBundle.getString("PreviewSeriesFrame.lblSubs"));
			...
			//---- label5 ----
			label5.setText(LocaleBundle.getString("PreviewSeriesFrame.lblFSK.text"));
			...
			//---- label9 ----
			label9.setText(LocaleBundle.getString("PreviewSeriesFrame.lblTags.text"));
			...
			//---- label6 ----
			label6.setText(LocaleBundle.getString("PreviewSeriesFrame.lblGroups"));
			...
			//---- label8 ----
			label8.setText(LocaleBundle.getString("PreviewSeriesFrame.lblGenres.text"));
			...
			//---- labelSpecialVersion ----
			labelSpecialVersion.setText(LocaleBundle.getString("PreviewSeriesFrame.labelSpecialVersion.text"));
			...
			//---- labelAnimeSeason ----
			labelAnimeSeason.setText(LocaleBundle.getString("PreviewSeriesFrame.labelAnimeSeason.text"));
			...
			//---- labelAnimeStudio ----
			labelAnimeStudio.setText(LocaleBundle.getString("PreviewSeriesFrame.labelAnimeStudio.text"));
		...
		//======== pnlMain ========
		{
			...
			pnlMain.setLayout(new FormLayout(
				"$lcgap, 17dlu, $lcgap, 0dlu:grow, $lcgap, 17dlu, $lcgap",
			...
			btnSeasonOnlinescore.setIcon(new ImageIcon(getClass().getResource("/icons/onlineReferences/ref01_16x16.png")));
