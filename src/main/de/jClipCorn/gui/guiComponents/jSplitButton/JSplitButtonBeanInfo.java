 ...
 */
package de.jClipCorn.gui.guiComponents.jSplitButton;
...
public class JSplitButtonBeanInfo extends SimpleBeanInfo {
    ...
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_ACCESSIBLE_CONTEXT] = new PropertyDescriptor ( "accessibleContext", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_ACTION] = new PropertyDescriptor ( "action", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getAction", "setAction" ); // NOI18N
            properties[PROPERTY_ACTION_COMMAND] = new PropertyDescriptor ( "actionCommand", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getActionCommand", "setActionCommand" ); // NOI18N
            properties[PROPERTY_ACTION_LISTENERS] = new PropertyDescriptor ( "actionListeners", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getActionListeners", null ); // NOI18N
            properties[PROPERTY_ACTION_MAP] = new PropertyDescriptor ( "actionMap", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_ALIGNMENT_X] = new PropertyDescriptor ( "alignmentX", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_ALIGNMENT_Y] = new PropertyDescriptor ( "alignmentY", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_ALWAYS_POPUP] = new PropertyDescriptor ( "alwaysPopup", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isAlwaysPopup", "setAlwaysPopup" ); // NOI18N
            properties[PROPERTY_ANCESTOR_LISTENERS] = new PropertyDescriptor ( "ancestorListeners", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_ARROW_COLOR] = new PropertyDescriptor ( "arrowColor", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getArrowColor", "setArrowColor" ); // NOI18N
            properties[PROPERTY_ARROW_SIZE] = new PropertyDescriptor ( "arrowSize", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getArrowSize", "setArrowSize" ); // NOI18N
            properties[PROPERTY_AUTOSCROLLS] = new PropertyDescriptor ( "autoscrolls", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_BACKGROUND] = new PropertyDescriptor ( "background", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_BACKGROUND_SET] = new PropertyDescriptor ( "backgroundSet", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_BASELINE_RESIZE_BEHAVIOR] = new PropertyDescriptor ( "baselineResizeBehavior", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_BORDER] = new PropertyDescriptor ( "border", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_BORDER_PAINTED] = new PropertyDescriptor ( "borderPainted", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isBorderPainted", "setBorderPainted" ); // NOI18N
            properties[PROPERTY_BOUNDS] = new PropertyDescriptor ( "bounds", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_CHANGE_LISTENERS] = new PropertyDescriptor ( "changeListeners", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getChangeListeners", null ); // NOI18N
            properties[PROPERTY_COLOR_MODEL] = new PropertyDescriptor ( "colorModel", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_COMPONENT] = new IndexedPropertyDescriptor ( "component", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_COMPONENT_COUNT] = new PropertyDescriptor ( "componentCount", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_COMPONENT_LISTENERS] = new PropertyDescriptor ( "componentListeners", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_COMPONENT_ORIENTATION] = new PropertyDescriptor ( "componentOrientation", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_COMPONENT_POPUP_MENU] = new PropertyDescriptor ( "componentPopupMenu", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getComponentPopupMenu", "setComponentPopupMenu" ); // NOI18N
            properties[PROPERTY_COMPONENTS] = new PropertyDescriptor ( "components", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_CONTAINER_LISTENERS] = new PropertyDescriptor ( "containerListeners", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getContainerListeners", null ); // NOI18N
            properties[PROPERTY_CONTENT_AREA_FILLED] = new PropertyDescriptor ( "contentAreaFilled", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isContentAreaFilled", "setContentAreaFilled" ); // NOI18N
            properties[PROPERTY_CURSOR] = new PropertyDescriptor ( "cursor", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_CURSOR_SET] = new PropertyDescriptor ( "cursorSet", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_DEBUG_GRAPHICS_OPTIONS] = new PropertyDescriptor ( "debugGraphicsOptions", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_DEFAULT_BUTTON] = new PropertyDescriptor ( "defaultButton", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isDefaultButton", null ); // NOI18N
            properties[PROPERTY_DEFAULT_CAPABLE] = new PropertyDescriptor ( "defaultCapable", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isDefaultCapable", "setDefaultCapable" ); // NOI18N
            properties[PROPERTY_DISABLED_ARROW_COLOR] = new PropertyDescriptor ( "disabledArrowColor", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getDisabledArrowColor", "setDisabledArrowColor" ); // NOI18N
            properties[PROPERTY_DISABLED_ICON] = new PropertyDescriptor ( "disabledIcon", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getDisabledIcon", "setDisabledIcon" ); // NOI18N
            properties[PROPERTY_DISABLED_IMAGE] = new PropertyDescriptor ( "disabledImage", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getDisabledImage", "setDisabledImage" ); // NOI18N
            properties[PROPERTY_DISABLED_SELECTED_ICON] = new PropertyDescriptor ( "disabledSelectedIcon", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getDisabledSelectedIcon", "setDisabledSelectedIcon" ); // NOI18N
            properties[PROPERTY_DISPLAYABLE] = new PropertyDescriptor ( "displayable", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_DISPLAYED_MNEMONIC_INDEX] = new PropertyDescriptor ( "displayedMnemonicIndex", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getDisplayedMnemonicIndex", "setDisplayedMnemonicIndex" ); // NOI18N
            properties[PROPERTY_DOUBLE_BUFFERED] = new PropertyDescriptor ( "doubleBuffered", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isDoubleBuffered", "setDoubleBuffered" ); // NOI18N
            properties[PROPERTY_DROP_TARGET] = new PropertyDescriptor ( "dropTarget", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_ENABLED] = new PropertyDescriptor ( "enabled", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_FOCUSABLE] = new PropertyDescriptor ( "focusable", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_FOCUS_CYCLE_ROOT] = new PropertyDescriptor ( "focusCycleRoot", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isFocusCycleRoot", "setFocusCycleRoot" ); // NOI18N
            properties[PROPERTY_FOCUS_CYCLE_ROOT_ANCESTOR] = new PropertyDescriptor ( "focusCycleRootAncestor", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_FOCUS_LISTENERS] = new PropertyDescriptor ( "focusListeners", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_FOCUS_OWNER] = new PropertyDescriptor ( "focusOwner", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_FOCUS_PAINTED] = new PropertyDescriptor ( "focusPainted", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isFocusPainted", "setFocusPainted" ); // NOI18N
            properties[PROPERTY_FOCUS_TRAVERSABLE] = new PropertyDescriptor ( "focusTraversable", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_FOCUS_TRAVERSAL_KEYS] = new IndexedPropertyDescriptor ( "focusTraversalKeys", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_FOCUS_TRAVERSAL_KEYS_ENABLED] = new PropertyDescriptor ( "focusTraversalKeysEnabled", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_FOCUS_TRAVERSAL_POLICY] = new PropertyDescriptor ( "focusTraversalPolicy", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy" ); // NOI18N
            properties[PROPERTY_FOCUS_TRAVERSAL_POLICY_PROVIDER] = new PropertyDescriptor ( "focusTraversalPolicyProvider", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider" ); // NOI18N
            properties[PROPERTY_FOCUS_TRAVERSAL_POLICY_SET] = new PropertyDescriptor ( "focusTraversalPolicySet", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isFocusTraversalPolicySet", null ); // NOI18N
            properties[PROPERTY_FONT] = new PropertyDescriptor ( "font", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_FONT_SET] = new PropertyDescriptor ( "fontSet", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_FOREGROUND] = new PropertyDescriptor ( "foreground", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_FOREGROUND_SET] = new PropertyDescriptor ( "foregroundSet", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_GRAPHICS] = new PropertyDescriptor ( "graphics", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_GRAPHICS_CONFIGURATION] = new PropertyDescriptor ( "graphicsConfiguration", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_HEIGHT] = new PropertyDescriptor ( "height", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_HIDE_ACTION_TEXT] = new PropertyDescriptor ( "hideActionText", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getHideActionText", "setHideActionText" ); // NOI18N
            properties[PROPERTY_HIERARCHY_BOUNDS_LISTENERS] = new PropertyDescriptor ( "hierarchyBoundsListeners", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_HIERARCHY_LISTENERS] = new PropertyDescriptor ( "hierarchyListeners", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_HORIZONTAL_ALIGNMENT] = new PropertyDescriptor ( "horizontalAlignment", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getHorizontalAlignment", "setHorizontalAlignment" ); // NOI18N
            properties[PROPERTY_HORIZONTAL_TEXT_POSITION] = new PropertyDescriptor ( "horizontalTextPosition", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getHorizontalTextPosition", "setHorizontalTextPosition" ); // NOI18N
            properties[PROPERTY_ICON] = new PropertyDescriptor ( "icon", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getIcon", "setIcon" ); // NOI18N
            properties[PROPERTY_ICON_TEXT_GAP] = new PropertyDescriptor ( "iconTextGap", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getIconTextGap", "setIconTextGap" ); // NOI18N
            properties[PROPERTY_IGNORE_REPAINT] = new PropertyDescriptor ( "ignoreRepaint", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_IMAGE] = new PropertyDescriptor ( "image", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getImage", "setImage" ); // NOI18N
            properties[PROPERTY_INHERITS_POPUP_MENU] = new PropertyDescriptor ( "inheritsPopupMenu", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_INPUT_CONTEXT] = new PropertyDescriptor ( "inputContext", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_INPUT_MAP] = new PropertyDescriptor ( "inputMap", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getInputMap", null ); // NOI18N
            properties[PROPERTY_INPUT_METHOD_LISTENERS] = new PropertyDescriptor ( "inputMethodListeners", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_INPUT_METHOD_REQUESTS] = new PropertyDescriptor ( "inputMethodRequests", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_INPUT_VERIFIER] = new PropertyDescriptor ( "inputVerifier", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getInputVerifier", "setInputVerifier" ); // NOI18N
            properties[PROPERTY_INSETS] = new PropertyDescriptor ( "insets", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_ITEM_LISTENERS] = new PropertyDescriptor ( "itemListeners", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getItemListeners", null ); // NOI18N
            properties[PROPERTY_KEY_LISTENERS] = new PropertyDescriptor ( "keyListeners", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getKeyListeners", null ); // NOI18N
            properties[PROPERTY_LABEL] = new PropertyDescriptor ( "label", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getLabel", "setLabel" ); // NOI18N
            properties[PROPERTY_LAYOUT] = new PropertyDescriptor ( "layout", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_LIGHTWEIGHT] = new PropertyDescriptor ( "lightweight", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_LOCALE] = new PropertyDescriptor ( "locale", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_LOCATION] = new PropertyDescriptor ( "location", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_LOCATION_ON_SCREEN] = new PropertyDescriptor ( "locationOnScreen", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_MANAGING_FOCUS] = new PropertyDescriptor ( "managingFocus", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isManagingFocus", null ); // NOI18N
            properties[PROPERTY_MARGIN] = new PropertyDescriptor ( "margin", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getMargin", "setMargin" ); // NOI18N
            properties[PROPERTY_MAXIMUM_SIZE] = new PropertyDescriptor ( "maximumSize", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_MAXIMUM_SIZE_SET] = new PropertyDescriptor ( "maximumSizeSet", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_MINIMUM_SIZE] = new PropertyDescriptor ( "minimumSize", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_MINIMUM_SIZE_SET] = new PropertyDescriptor ( "minimumSizeSet", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_MNEMONIC] = new PropertyDescriptor ( "mnemonic", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, null, "setMnemonic" ); // NOI18N
            properties[PROPERTY_MODEL] = new PropertyDescriptor ( "model", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getModel", "setModel" ); // NOI18N
            properties[PROPERTY_MOUSE_LISTENERS] = new PropertyDescriptor ( "mouseListeners", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getMouseListeners", null ); // NOI18N
            properties[PROPERTY_MOUSE_MOTION_LISTENERS] = new PropertyDescriptor ( "mouseMotionListeners", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getMouseMotionListeners", null ); // NOI18N
            properties[PROPERTY_MOUSE_POSITION] = new PropertyDescriptor ( "mousePosition", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getMousePosition", null ); // NOI18N
            properties[PROPERTY_MOUSE_WHEEL_LISTENERS] = new PropertyDescriptor ( "mouseWheelListeners", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getMouseWheelListeners", null ); // NOI18N
            properties[PROPERTY_MULTI_CLICK_THRESHHOLD] = new PropertyDescriptor ( "multiClickThreshhold", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getMultiClickThreshhold", "setMultiClickThreshhold" ); // NOI18N
            properties[PROPERTY_NAME] = new PropertyDescriptor ( "name", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_NEXT_FOCUSABLE_COMPONENT] = new PropertyDescriptor ( "nextFocusableComponent", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_OPAQUE] = new PropertyDescriptor ( "opaque", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_OPTIMIZED_DRAWING_ENABLED] = new PropertyDescriptor ( "optimizedDrawingEnabled", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_PAINTING_FOR_PRINT] = new PropertyDescriptor ( "paintingForPrint", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_PAINTING_TILE] = new PropertyDescriptor ( "paintingTile", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_PARENT] = new PropertyDescriptor ( "parent", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getParent", null ); // NOI18N
            properties[PROPERTY_PEER] = new PropertyDescriptor ( "peer", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getPeer", null ); // NOI18N
            properties[PROPERTY_POPUP_MENU] = new PropertyDescriptor ( "popupMenu", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getPopupMenu", "setPopupMenu" ); // NOI18N
            properties[PROPERTY_PREFERRED_SIZE] = new PropertyDescriptor ( "preferredSize", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_PREFERRED_SIZE_SET] = new PropertyDescriptor ( "preferredSizeSet", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_PRESSED_ICON] = new PropertyDescriptor ( "pressedIcon", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getPressedIcon", "setPressedIcon" ); // NOI18N
            properties[PROPERTY_PROPERTY_CHANGE_LISTENERS] = new PropertyDescriptor ( "propertyChangeListeners", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_REGISTERED_KEY_STROKES] = new PropertyDescriptor ( "registeredKeyStrokes", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_REQUEST_FOCUS_ENABLED] = new PropertyDescriptor ( "requestFocusEnabled", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_ROLLOVER_ENABLED] = new PropertyDescriptor ( "rolloverEnabled", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isRolloverEnabled", "setRolloverEnabled" ); // NOI18N
            properties[PROPERTY_ROLLOVER_ICON] = new PropertyDescriptor ( "rolloverIcon", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getRolloverIcon", "setRolloverIcon" ); // NOI18N
            properties[PROPERTY_ROLLOVER_SELECTED_ICON] = new PropertyDescriptor ( "rolloverSelectedIcon", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getRolloverSelectedIcon", "setRolloverSelectedIcon" ); // NOI18N
            properties[PROPERTY_ROOT_PANE] = new PropertyDescriptor ( "rootPane", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_SELECTED] = new PropertyDescriptor ( "selected", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isSelected", "setSelected" ); // NOI18N
            properties[PROPERTY_SELECTED_ICON] = new PropertyDescriptor ( "selectedIcon", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getSelectedIcon", "setSelectedIcon" ); // NOI18N
            properties[PROPERTY_SELECTED_OBJECTS] = new PropertyDescriptor ( "selectedObjects", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getSelectedObjects", null ); // NOI18N
            properties[PROPERTY_SEPARATOR_SPACING] = new PropertyDescriptor ( "separatorSpacing", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getSeparatorSpacing", "setSeparatorSpacing" ); // NOI18N
            properties[PROPERTY_SHOWING] = new PropertyDescriptor ( "showing", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_SIZE] = new PropertyDescriptor ( "size", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_SPLIT_WIDTH] = new PropertyDescriptor ( "splitWidth", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getSplitWidth", "setSplitWidth" ); // NOI18N
            properties[PROPERTY_TEXT] = new PropertyDescriptor ( "text", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getText", "setText" ); // NOI18N
            properties[PROPERTY_TOOLKIT] = new PropertyDescriptor ( "toolkit", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_TOOL_TIP_TEXT] = new PropertyDescriptor ( "toolTipText", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_TOP_LEVEL_ANCESTOR] = new PropertyDescriptor ( "topLevelAncestor", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_TRANSFER_HANDLER] = new PropertyDescriptor ( "transferHandler", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_TREE_LOCK] = new PropertyDescriptor ( "treeLock", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_UI] = new PropertyDescriptor ( "UI", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getUI", "setUI" ); // NOI18N
            properties[PROPERTY_UI_CLASS_ID] = new PropertyDescriptor ( "UIClassID", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_VALID] = new PropertyDescriptor ( "valid", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isValid", null ); // NOI18N
            properties[PROPERTY_VALIDATE_ROOT] = new PropertyDescriptor ( "validateRoot", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_VERIFY_INPUT_WHEN_FOCUS_TARGET] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_VERTICAL_ALIGNMENT] = new PropertyDescriptor ( "verticalAlignment", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getVerticalAlignment", "setVerticalAlignment" ); // NOI18N
            properties[PROPERTY_VERTICAL_TEXT_POSITION] = new PropertyDescriptor ( "verticalTextPosition", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getVerticalTextPosition", "setVerticalTextPosition" ); // NOI18N
            properties[PROPERTY_VETOABLE_CHANGE_LISTENERS] = new PropertyDescriptor ( "vetoableChangeListeners", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getVetoableChangeListeners", null ); // NOI18N
            properties[PROPERTY_VISIBLE] = new PropertyDescriptor ( "visible", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_VISIBLE_RECT] = new PropertyDescriptor ( "visibleRect", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_WIDTH] = new PropertyDescriptor ( "width", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_X] = new PropertyDescriptor ( "x", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getX", null ); // NOI18N
            properties[PROPERTY_Y] = new PropertyDescriptor ( "y", de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ACTION_LISTENER] = new EventSetDescriptor ( de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "actionListener", java.awt.event.ActionListener.class, new String[] {"actionPerformed"}, "addActionListener", "removeActionListener" ); // NOI18N
            eventSets[EVENT_ANCESTOR_LISTENER] = new EventSetDescriptor ( de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_BUTTON_CLICKED_ACTION_LISTENER] = new EventSetDescriptor ( de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "buttonClickedActionListener", de.jClipCorn.gui.guiComponents.jSplitButton.action.ButtonClickedActionListener.class, new String[] {}, "addButtonClickedActionListener", "removeButtonClickedActionListener" ); // NOI18N
            eventSets[EVENT_CHANGE_LISTENER] = new EventSetDescriptor ( de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "changeListener", javax.swing.event.ChangeListener.class, new String[] {"stateChanged"}, "addChangeListener", "removeChangeListener" ); // NOI18N
            eventSets[EVENT_COMPONENT_LISTENER] = new EventSetDescriptor ( de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_CONTAINER_LISTENER] = new EventSetDescriptor ( de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_FOCUS_LISTENER] = new EventSetDescriptor ( de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_HIERARCHY_BOUNDS_LISTENER] = new EventSetDescriptor ( de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_HIERARCHY_LISTENER] = new EventSetDescriptor ( de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_INPUT_METHOD_LISTENER] = new EventSetDescriptor ( de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_ITEM_LISTENER] = new EventSetDescriptor ( de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "itemListener", java.awt.event.ItemListener.class, new String[] {"itemStateChanged"}, "addItemListener", "removeItemListener" ); // NOI18N
            eventSets[EVENT_KEY_LISTENER] = new EventSetDescriptor ( de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_MOUSE_LISTENER] = new EventSetDescriptor ( de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_MOUSE_MOTION_LISTENER] = new EventSetDescriptor ( de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_MOUSE_WHEEL_LISTENER] = new EventSetDescriptor ( de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_PROPERTY_CHANGE_LISTENER] = new EventSetDescriptor ( de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_SPLIT_BUTTON_ACTION_LISTENER] = new EventSetDescriptor ( de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "splitButtonActionListener", de.jClipCorn.gui.guiComponents.jSplitButton.action.SplitButtonActionListener.class, new String[] {"buttonClicked", "splitButtonClicked"}, "addSplitButtonActionListener", "removeSplitButtonActionListener" ); // NOI18N
            eventSets[EVENT_SPLIT_BUTTON_ACTION_LISTENER].setInDefaultEventSet ( false );
            eventSets[EVENT_SPLIT_BUTTON_CLICKED_ACTION_LISTENER] = new EventSetDescriptor ( de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "splitButtonClickedActionListener", de.jClipCorn.gui.guiComponents.jSplitButton.action.SplitButtonClickedActionListener.class, new String[] {}, "addSplitButtonClickedActionListener", "removeSplitButtonClickedActionListener" ); // NOI18N
            eventSets[EVENT_VETOABLE_CHANGE_LISTENER] = new EventSetDescriptor ( de.jClipCorn.gui.guiComponents.jSplitButton.JSplitButton.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
