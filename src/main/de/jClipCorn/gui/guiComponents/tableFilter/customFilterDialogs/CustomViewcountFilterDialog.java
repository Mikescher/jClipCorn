...
public class CustomViewcountFilterDialog extends CustomFilterDialog {
	...
	private void initGUI() {
		...
		lblType = new JLabel(LocaleBundle.getString("FilterTree.Custom.FilterFrames.Viewcount")); //$NON-NLS-1$
		...
		spnLesser.setModel(new SpinnerNumberModel(1, 1, null, 1));
		...
		spnGreater.setModel(new SpinnerNumberModel(1, 1, null, 1));
		...
		spnBetween1.setModel(new SpinnerNumberModel(1, 1, null, 1));
		...
		spnBetween2.setModel(new SpinnerNumberModel(1, 1, null, 1));
		...
		spnExactly.setModel(new SpinnerNumberModel(1, 1, null, 1));
