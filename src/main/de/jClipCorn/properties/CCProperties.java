...
public class CCProperties implements ICCPropertySource {
	...
	public CCExecutableProperty                             PROP_PLAY_PRIMARY_MEDIAPLAYER;
	...
	public CCFrameSizeProperty                              PROP_FSIZE_ADDMULTIEPISODESFRAME;
	public CCFrameSizeProperty                              PROP_FSIZE_APPLYPATCHFRAME;
	public CCFrameSizeProperty                              PROP_FSIZE_BACKUPSMANAGERFRAME;
	public CCFrameSizeProperty                              PROP_FSIZE_COMPAREDATABASEFRAME;
	public CCFrameSizeProperty                              PROP_FSIZE_CREATENFOFRAME;
	public CCFrameSizeProperty                              PROP_FSIZE_CUSTOMFILTEREDITDIALOG;
	public CCFrameSizeProperty                              PROP_FSIZE_EDITMEDIAINFODIALOG;
	public CCFrameSizeProperty                              PROP_FSIZE_EXPORTELEMENTSFRAME;
	public CCFrameSizeProperty                              PROP_FSIZE_EXTENDEDSETTINGSFRAME;
	public CCFrameSizeProperty                              PROP_FSIZE_FILENAMERULEFRAME;
	public CCFrameSizeProperty                              PROP_FSIZE_FINDCOVERDIALOG;
	public CCFrameSizeProperty                              PROP_FSIZE_GROUPMANAGEFRAME;
	public CCFrameSizeProperty                              PROP_FSIZE_IMPORTELEMENTSFRAME;
	public CCFrameSizeProperty                              PROP_FSIZE_MASSMOVEMOVIESDIALOG;
	public CCFrameSizeProperty                              PROP_FSIZE_MASSMOVESERIESDIALOG;
	public CCFrameSizeProperty                              PROP_FSIZE_OMNIPARSERFRAME;
	public CCFrameSizeProperty                              PROP_FSIZE_ORGANIZEFILTERDIALOG;
	public CCFrameSizeProperty                              PROP_FSIZE_PARSEWATCHDATAFRAME;
	public CCFrameSizeProperty                              PROP_FSIZE_QUICKADDEPISODEDIALOG;
	public CCFrameSizeProperty                              PROP_FSIZE_QUICKADDMOVIESDIALOG;
	public CCFrameSizeProperty                              PROP_FSIZE_RANDOMMOVIEFRAME;
	public CCFrameSizeProperty                              PROP_FSIZE_SEARCHFRAME;
	public CCFrameSizeProperty                              PROP_FSIZE_SHOWINCOMPLETEFILMSERIESFRAME;
	public CCFrameSizeProperty                              PROP_FSIZE_TEXTEXPORTFRAME;
	public CCFrameSizeProperty                              PROP_FSIZE_UPDATECODECFRAME;
	public CCFrameSizeProperty                              PROP_FSIZE_UPDATEMETADATAFRAME;
	public CCFrameSizeProperty                              PROP_FSIZE_VLCROBOTFRAME;
	...
	private void createProperties() {
		...
		PROP_FSIZE_ADDMULTIEPISODESFRAME            = new CCFrameSizeProperty(CAT_FRAMESIZES,   this,   "PROP_FSIZE_ADDMULTIEPISODESFRAME",            new FrameSizeVar(1600, 650));
		PROP_FSIZE_APPLYPATCHFRAME                  = new CCFrameSizeProperty(CAT_FRAMESIZES,   this,   "PROP_FSIZE_APPLYPATCHFRAME",                  new FrameSizeVar(900, 625));
		PROP_FSIZE_BACKUPSMANAGERFRAME              = new CCFrameSizeProperty(CAT_FRAMESIZES,   this,   "PROP_FSIZE_BACKUPSMANAGERFRAME",              new FrameSizeVar(800, 575));
		PROP_FSIZE_COMPAREDATABASEFRAME             = new CCFrameSizeProperty(CAT_FRAMESIZES,   this,   "PROP_FSIZE_COMPAREDATABASEFRAME",             new FrameSizeVar(925, 885));
		PROP_FSIZE_CREATENFOFRAME                   = new CCFrameSizeProperty(CAT_FRAMESIZES,   this,   "PROP_FSIZE_CREATENFOFRAME",                   new FrameSizeVar(800, 550));
		PROP_FSIZE_CUSTOMFILTEREDITDIALOG           = new CCFrameSizeProperty(CAT_FRAMESIZES,   this,   "PROP_FSIZE_CUSTOMFILTEREDITDIALOG",           new FrameSizeVar(800, 500));
		PROP_FSIZE_EDITMEDIAINFODIALOG              = new CCFrameSizeProperty(CAT_FRAMESIZES,   this,   "PROP_FSIZE_EDITMEDIAINFODIALOG",              new FrameSizeVar(1300, 775));
		PROP_FSIZE_EXPORTELEMENTSFRAME              = new CCFrameSizeProperty(CAT_FRAMESIZES,   this,   "PROP_FSIZE_EXPORTELEMENTSFRAME",              new FrameSizeVar(300, 350));
		PROP_FSIZE_EXTENDEDSETTINGSFRAME            = new CCFrameSizeProperty(CAT_FRAMESIZES,   this,   "PROP_FSIZE_EXTENDEDSETTINGSFRAME",            new FrameSizeVar(0, 0));
		PROP_FSIZE_FILENAMERULEFRAME                = new CCFrameSizeProperty(CAT_FRAMESIZES,   this,   "PROP_FSIZE_FILENAMERULEFRAME",                new FrameSizeVar(750, 500));
		PROP_FSIZE_FINDCOVERDIALOG                  = new CCFrameSizeProperty(CAT_FRAMESIZES,   this,   "PROP_FSIZE_FINDCOVERDIALOG",                  new FrameSizeVar(800, 480));
		PROP_FSIZE_GROUPMANAGEFRAME                 = new CCFrameSizeProperty(CAT_FRAMESIZES,   this,   "PROP_FSIZE_GROUPMANAGEFRAME",                 new FrameSizeVar(1000, 700));
		PROP_FSIZE_IMPORTELEMENTSFRAME              = new CCFrameSizeProperty(CAT_FRAMESIZES,   this,   "PROP_FSIZE_IMPORTELEMENTSFRAME",              new FrameSizeVar(950, 660));
		PROP_FSIZE_MASSMOVEMOVIESDIALOG             = new CCFrameSizeProperty(CAT_FRAMESIZES,   this,   "PROP_FSIZE_MASSMOVEMOVIESDIALOG",             new FrameSizeVar(705, 750));
		PROP_FSIZE_MASSMOVESERIESDIALOG             = new CCFrameSizeProperty(CAT_FRAMESIZES,   this,   "PROP_FSIZE_MASSMOVESERIESDIALOG",             new FrameSizeVar(705, 750));
		PROP_FSIZE_OMNIPARSERFRAME                  = new CCFrameSizeProperty(CAT_FRAMESIZES,   this,   "PROP_FSIZE_OMNIPARSERFRAME",                  new FrameSizeVar(1100, 570));
		PROP_FSIZE_ORGANIZEFILTERDIALOG             = new CCFrameSizeProperty(CAT_FRAMESIZES,   this,   "PROP_FSIZE_ORGANIZEFILTERDIALOG",             new FrameSizeVar(350, 300));
		PROP_FSIZE_PARSEWATCHDATAFRAME              = new CCFrameSizeProperty(CAT_FRAMESIZES,   this,   "PROP_FSIZE_PARSEWATCHDATAFRAME",              new FrameSizeVar(1100, 600));
		PROP_FSIZE_QUICKADDEPISODEDIALOG            = new CCFrameSizeProperty(CAT_FRAMESIZES,   this,   "PROP_FSIZE_QUICKADDEPISODEDIALOG",            new FrameSizeVar(550, 425));
		PROP_FSIZE_QUICKADDMOVIESDIALOG             = new CCFrameSizeProperty(CAT_FRAMESIZES,   this,   "PROP_FSIZE_QUICKADDMOVIESDIALOG",             new FrameSizeVar(500, 300));
		PROP_FSIZE_RANDOMMOVIEFRAME                 = new CCFrameSizeProperty(CAT_FRAMESIZES,   this,   "PROP_FSIZE_RANDOMMOVIEFRAME",                 new FrameSizeVar(0, 0));
		PROP_FSIZE_SEARCHFRAME                      = new CCFrameSizeProperty(CAT_FRAMESIZES,   this,   "PROP_FSIZE_SEARCHFRAME",                      new FrameSizeVar(600, 400));
		PROP_FSIZE_SHOWINCOMPLETEFILMSERIESFRAME    = new CCFrameSizeProperty(CAT_FRAMESIZES,   this,   "PROP_FSIZE_SHOWINCOMPLETEFILMSERIESFRAME",    new FrameSizeVar(450, 550));
		PROP_FSIZE_TEXTEXPORTFRAME                  = new CCFrameSizeProperty(CAT_FRAMESIZES,   this,   "PROP_FSIZE_TEXTEXPORTFRAME",                  new FrameSizeVar(600, 620));
		PROP_FSIZE_UPDATECODECFRAME                 = new CCFrameSizeProperty(CAT_FRAMESIZES,   this,   "PROP_FSIZE_UPDATECODECFRAME",                 new FrameSizeVar(1200, 650));
		PROP_FSIZE_UPDATEMETADATAFRAME              = new CCFrameSizeProperty(CAT_FRAMESIZES,   this,   "PROP_FSIZE_UPDATEMETADATAFRAME",              new FrameSizeVar(1200, 650));
		PROP_FSIZE_VLCROBOTFRAME                    = new CCFrameSizeProperty(CAT_FRAMESIZES,   this,   "PROP_FSIZE_VLCROBOTFRAME",                    new FrameSizeVar(500, 380));
