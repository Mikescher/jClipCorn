...
public class FFMPEGPathConf implements CCExecutableProperty.ExecPathValidator {

	public static FFMPEGPathConf INST = new FFMPEGPathConf();
	...
	public boolean Validate(FSPath p) {
		...
		try
		{
			...
			if (!proc.Item2.contains("ffmpeg version"))
			{
