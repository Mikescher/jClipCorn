...
public class CustomEpisodecountFilterDialog extends CustomFilterDialog {
	...
	private void initGUI() {
		...
		spnLesser.setModel(new SpinnerNumberModel(1, 0, null, 1));
		...
		spnGreater.setModel(new SpinnerNumberModel(1, 0, null, 1));
		...
		spnBetween1.setModel(new SpinnerNumberModel(1, 0, null, 1));
		...
		spnBetween2.setModel(new SpinnerNumberModel(1, 0, null, 1));
		...
		spnExactly.setModel(new SpinnerNumberModel(1, 0, null, 1));
