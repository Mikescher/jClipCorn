...
public class TestMetadataRunner_FFProbeFull extends ClipCornBaseTest
{
	@Test
	public void testMetadataRunner_000_ffprobefull() throws Exception {
		...
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_000.mp4"));

		assertEquals(MetadataSourceType.FFPROBE_FULL, vmd.SourceType);
	...
	@Test
	public void testMetadataRunner_001_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_001.mkv"));
	...
	@Test
	public void testMetadataRunner_002_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_002.avi"));
		...
		assertOptEquals(96, vmd.getDefaultVideoTrack().flatErrMap(p -> p.Height));
		assertOptEquals(25.0, vmd.getDefaultVideoTrack().flatErrMap(p -> p.FrameRate));
		assertOptEquals(87500, vmd.getDefaultVideoTrack().flatErrMap(p -> p.FrameCount));
		...
		assertOptEquals(96, vmd.VideoTracks.get(0).Height);
		assertOptEquals(25.0, vmd.VideoTracks.get(0).FrameRate);
		assertOptEquals(87500, vmd.VideoTracks.get(0).FrameCount);
	...
	@Test
	public void testMetadataRunner_003_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_003.mkv"));
	...
	@Test
	public void testMetadataRunner_004_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_004.mp4"));
	...
	@Test
	public void testMetadataRunner_005_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_005.mkv"));
	...
	@Test
	public void testMetadataRunner_006_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_006.avi"));
		...
		assertOptEquals(96, vmd.getDefaultVideoTrack().flatErrMap(p -> p.Height));
		assertOptEquals(25.0, vmd.getDefaultVideoTrack().flatErrMap(p -> p.FrameRate));
		assertOptEquals(187625, vmd.getDefaultVideoTrack().flatErrMap(p -> p.FrameCount));
		assertOptEmpty(vmd.getDefaultVideoTrack().flatErrMap(p -> p.BitDepth));
		assertOptEmpty(vmd.getDefaultVideoTrack().flatErrMap(p -> p.Duration));
		assertOptEquals(false, vmd.getDefaultVideoTrack().flatErrMap(p -> p.Default));
		...
		assertOptEquals(96, vmd.VideoTracks.get(0).Height);
		assertOptEquals(25.0, vmd.VideoTracks.get(0).FrameRate);
		assertOptEquals(187625, vmd.VideoTracks.get(0).FrameCount);
		assertOptEmpty(vmd.VideoTracks.get(0).BitDepth);
		assertOptEmpty(vmd.VideoTracks.get(0).Duration);
		assertOptEquals(false, vmd.VideoTracks.get(0).Default);
		assertOptEmpty(vmd.VideoTracks.get(0).calcCCDBLanguage());
	...
	@Test
	public void testMetadataRunner_007_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_007.mkv"));
	...
	@Test
	public void testMetadataRunner_008_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_008.mpeg"));
		...
		assertOptEquals(96, vmd.getDefaultVideoTrack().flatErrMap(p -> p.Height));
		assertOptEquals(25.0, vmd.getDefaultVideoTrack().flatErrMap(p -> p.FrameRate));
		assertOptEquals(142625, vmd.getDefaultVideoTrack().flatErrMap(p -> p.FrameCount));
		assertOptEmpty(vmd.getDefaultVideoTrack().flatErrMap(p -> p.BitDepth));
		assertOptEmpty(vmd.getDefaultVideoTrack().flatErrMap(p -> p.Duration));
		assertOptEquals(false, vmd.getDefaultVideoTrack().flatErrMap(p -> p.Default));
		...
		assertOptEquals(96, vmd.VideoTracks.get(0).Height);
		assertOptEquals(25.0, vmd.VideoTracks.get(0).FrameRate);
		assertOptEquals(142625, vmd.VideoTracks.get(0).FrameCount);
		assertOptEmpty(vmd.VideoTracks.get(0).BitDepth);
		assertOptEmpty(vmd.VideoTracks.get(0).Duration);
		assertOptEquals(false, vmd.VideoTracks.get(0).Default);
		assertOptEmpty(vmd.VideoTracks.get(0).calcCCDBLanguage());
	...
	@Test
	public void testMetadataRunner_009_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_009.mkv"));
	...
	@Test
	public void testMetadataRunner_010_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_010.mpeg"));
	...
	@Test
	public void testMetadataRunner_011_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_011.mkv"));
	...
	@Test
	public void testMetadataRunner_012_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_012.mp4"));
	...
	@Test
	public void testMetadataRunner_013_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_013.mkv"));
	...
	@Test
	public void testMetadataRunner_014_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_014.avi"));
	...
	@Test
	public void testMetadataRunner_015_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_015.mkv"));
	...
	@Test
	public void testMetadataRunner_016_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_016.mp4"));
	...
	@Test
	public void testMetadataRunner_017_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_017.mkv"));
	...
	@Test
	public void testMetadataRunner_018_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_018.avi"));
	...
	@Test
	public void testMetadataRunner_019_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_019.mkv"));
	...
	@Test
	public void testMetadataRunner_020_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_020.wmv"));
		...
		assertOptEquals(96, vmd.getDefaultVideoTrack().flatErrMap(p -> p.Height));
		assertOptEquals(25.0, vmd.getDefaultVideoTrack().flatErrMap(p -> p.FrameRate));
		assertOptEquals(125375, vmd.getDefaultVideoTrack().flatErrMap(p -> p.FrameCount));
		assertOptEmpty(vmd.getDefaultVideoTrack().flatErrMap(p -> p.BitDepth));
		assertOptEmpty(vmd.getDefaultVideoTrack().flatErrMap(p -> p.Duration));
		assertOptEquals(false, vmd.getDefaultVideoTrack().flatErrMap(p -> p.Default));
		...
		assertOptEquals(96, vmd.VideoTracks.get(0).Height);
		assertOptEquals(25.0, vmd.VideoTracks.get(0).FrameRate);
		assertOptEquals(125375, vmd.VideoTracks.get(0).FrameCount);
		assertOptEmpty(vmd.VideoTracks.get(0).BitDepth);
		assertOptEmpty(vmd.VideoTracks.get(0).Duration);
		assertOptEquals(false, vmd.VideoTracks.get(0).Default);
		assertOptEmpty(vmd.VideoTracks.get(0).calcCCDBLanguage());
	...
	@Test
	public void testMetadataRunner_021_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_021.mkv"));
	...
	@Test
	public void testMetadataRunner_022_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_022.avi"));
		...
		assertOptEquals(96, vmd.getDefaultVideoTrack().flatErrMap(p -> p.Height));
		assertOptEquals(25.0, vmd.getDefaultVideoTrack().flatErrMap(p -> p.FrameRate));
		assertOptEquals(130175, vmd.getDefaultVideoTrack().flatErrMap(p -> p.FrameCount));
		assertOptEmpty(vmd.getDefaultVideoTrack().flatErrMap(p -> p.BitDepth));
		assertOptEmpty(vmd.getDefaultVideoTrack().flatErrMap(p -> p.Duration));
		assertOptEquals(false, vmd.getDefaultVideoTrack().flatErrMap(p -> p.Default));
		...
		assertOptEquals(96, vmd.VideoTracks.get(0).Height);
		assertOptEquals(25.0, vmd.VideoTracks.get(0).FrameRate);
		assertOptEquals(130175, vmd.VideoTracks.get(0).FrameCount);
		assertOptEmpty(vmd.VideoTracks.get(0).BitDepth);
		assertOptEmpty(vmd.VideoTracks.get(0).Duration);
		assertOptEquals(false, vmd.VideoTracks.get(0).Default);
		assertOptEmpty(vmd.VideoTracks.get(0).calcCCDBLanguage());
	...
	@Test
	public void testMetadataRunner_023_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_023.mkv"));
	...
	@Test
	public void testMetadataRunner_024_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_024.mp4"));
	...
	@Test
	public void testMetadataRunner_025_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_025.mkv"));
	...
	@Test
	public void testMetadataRunner_026_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_026.avi"));
		...
		assertOptEquals(96, vmd.getDefaultVideoTrack().flatErrMap(p -> p.Height));
		assertOptEquals(25.0, vmd.getDefaultVideoTrack().flatErrMap(p -> p.FrameRate));
		assertOptEquals(162700, vmd.getDefaultVideoTrack().flatErrMap(p -> p.FrameCount));
		assertOptEmpty(vmd.getDefaultVideoTrack().flatErrMap(p -> p.BitDepth));
		assertOptEmpty(vmd.getDefaultVideoTrack().flatErrMap(p -> p.Duration));
		assertOptEquals(false, vmd.getDefaultVideoTrack().flatErrMap(p -> p.Default));
		...
		assertOptEquals(96, vmd.VideoTracks.get(0).Height);
		assertOptEquals(25.0, vmd.VideoTracks.get(0).FrameRate);
		assertOptEquals(162700, vmd.VideoTracks.get(0).FrameCount);
		assertOptEmpty(vmd.VideoTracks.get(0).BitDepth);
		assertOptEmpty(vmd.VideoTracks.get(0).Duration);
		assertOptEquals(false, vmd.VideoTracks.get(0).Default);
		assertOptEmpty(vmd.VideoTracks.get(0).calcCCDBLanguage());
	...
	@Test
	public void testMetadataRunner_027_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_027.mkv"));
	...
	@Test
	public void testMetadataRunner_028_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_028.mp4"));
	...
	@Test
	public void testMetadataRunner_029_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_029.mkv"));
	...
	@Test
	public void testMetadataRunner_030_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_030.avi"));
		...
		assertOptEquals(96, vmd.getDefaultVideoTrack().flatErrMap(p -> p.Height));
		assertOptEquals(25.0, vmd.getDefaultVideoTrack().flatErrMap(p -> p.FrameRate));
		assertOptEquals(91050, vmd.getDefaultVideoTrack().flatErrMap(p -> p.FrameCount));
		assertOptEmpty(vmd.getDefaultVideoTrack().flatErrMap(p -> p.BitDepth));
		assertOptEmpty(vmd.getDefaultVideoTrack().flatErrMap(p -> p.Duration));
		assertOptEquals(false, vmd.getDefaultVideoTrack().flatErrMap(p -> p.Default));
		...
		assertOptEquals(96, vmd.VideoTracks.get(0).Height);
		assertOptEquals(25.0, vmd.VideoTracks.get(0).FrameRate);
		assertOptEquals(91050, vmd.VideoTracks.get(0).FrameCount);
		assertOptEmpty(vmd.VideoTracks.get(0).BitDepth);
		assertOptEmpty(vmd.VideoTracks.get(0).Duration);
		assertOptEquals(false, vmd.VideoTracks.get(0).Default);
		assertOptEmpty(vmd.VideoTracks.get(0).calcCCDBLanguage());
	...
	@Test
	public void testMetadataRunner_031_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_031.mkv"));
	...
	@Test
	public void testMetadataRunner_032_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_032.mp4"));
	...
	@Test
	public void testMetadataRunner_033_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_033.mkv"));
	...
	@Test
	public void testMetadataRunner_034_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_034.avi"));
	...
	@Test
	public void testMetadataRunner_035_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_035.mkv"));
	...
	@Test
	public void testMetadataRunner_036_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_036.mp4"));
	...
	@Test
	public void testMetadataRunner_037_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_037.mkv"));
	...
	@Test
	public void testMetadataRunner_038_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_038.avi"));
		...
		assertOptEquals(96, vmd.getDefaultVideoTrack().flatErrMap(p -> p.Height));
		assertOptEquals(25.0, vmd.getDefaultVideoTrack().flatErrMap(p -> p.FrameRate));
		assertOptEquals(90000, vmd.getDefaultVideoTrack().flatErrMap(p -> p.FrameCount));
		assertOptEmpty(vmd.getDefaultVideoTrack().flatErrMap(p -> p.BitDepth));
		assertOptEmpty(vmd.getDefaultVideoTrack().flatErrMap(p -> p.Duration));
		assertOptEquals(false, vmd.getDefaultVideoTrack().flatErrMap(p -> p.Default));
		...
		assertOptEquals(96, vmd.VideoTracks.get(0).Height);
		assertOptEquals(25.0, vmd.VideoTracks.get(0).FrameRate);
		assertOptEquals(90000, vmd.VideoTracks.get(0).FrameCount);
		assertOptEmpty(vmd.VideoTracks.get(0).BitDepth);
		assertOptEmpty(vmd.VideoTracks.get(0).Duration);
		assertOptEquals(false, vmd.VideoTracks.get(0).Default);
		assertOptEmpty(vmd.VideoTracks.get(0).calcCCDBLanguage());
	...
	@Test
	public void testMetadataRunner_039_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_039.mkv"));
	...
	@Test
	public void testMetadataRunner_040_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_040.mp4"));
	...
	@Test
	public void testMetadataRunner_041_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_041.mkv"));
	...
	@Test
	public void testMetadataRunner_042_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_042.avi"));
		...
		assertOptEquals(96, vmd.getDefaultVideoTrack().flatErrMap(p -> p.Height));
		assertOptEquals(25.0, vmd.getDefaultVideoTrack().flatErrMap(p -> p.FrameRate));
		assertOptEquals(114275, vmd.getDefaultVideoTrack().flatErrMap(p -> p.FrameCount));
		assertOptEmpty(vmd.getDefaultVideoTrack().flatErrMap(p -> p.BitDepth));
		assertOptEmpty(vmd.getDefaultVideoTrack().flatErrMap(p -> p.Duration));
		assertOptEquals(false, vmd.getDefaultVideoTrack().flatErrMap(p -> p.Default));
		...
		assertOptEquals(96, vmd.VideoTracks.get(0).Height);
		assertOptEquals(25.0, vmd.VideoTracks.get(0).FrameRate);
		assertOptEquals(114275, vmd.VideoTracks.get(0).FrameCount);
		assertOptEmpty(vmd.VideoTracks.get(0).BitDepth);
		assertOptEmpty(vmd.VideoTracks.get(0).Duration);
		assertOptEquals(false, vmd.VideoTracks.get(0).Default);
		assertOptEmpty(vmd.VideoTracks.get(0).calcCCDBLanguage());
	...
	@Test
	public void testMetadataRunner_043_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_043.mkv"));
	...
	@Test
	public void testMetadataRunner_044_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_044.mp4"));
	...
	@Test
	public void testMetadataRunner_045_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_045.mkv"));
	...
	@Test
	public void testMetadataRunner_046_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_046.avi"));
		...
		assertOptEquals(96, vmd.getDefaultVideoTrack().flatErrMap(p -> p.Height));
		assertOptEquals(25.0, vmd.getDefaultVideoTrack().flatErrMap(p -> p.FrameRate));
		assertOptEquals(127325, vmd.getDefaultVideoTrack().flatErrMap(p -> p.FrameCount));
		assertOptEmpty(vmd.getDefaultVideoTrack().flatErrMap(p -> p.BitDepth));
		assertOptEmpty(vmd.getDefaultVideoTrack().flatErrMap(p -> p.Duration));
		assertOptEquals(false, vmd.getDefaultVideoTrack().flatErrMap(p -> p.Default));
		...
		assertOptEquals(96, vmd.VideoTracks.get(0).Height);
		assertOptEquals(25.0, vmd.VideoTracks.get(0).FrameRate);
		assertOptEquals(127325, vmd.VideoTracks.get(0).FrameCount);
		assertOptEmpty(vmd.VideoTracks.get(0).BitDepth);
		assertOptEmpty(vmd.VideoTracks.get(0).Duration);
		assertOptEquals(false, vmd.VideoTracks.get(0).Default);
		assertOptEmpty(vmd.VideoTracks.get(0).calcCCDBLanguage());
	...
	@Test
	public void testMetadataRunner_047_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_047.mkv"));
	...
	@Test
	public void testMetadataRunner_048_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_048.mp4"));
	...
	@Test
	public void testMetadataRunner_049_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_049.mkv"));
	...
	@Test
	public void testMetadataRunner_050_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_050.avi"));
		...
		assertOptEquals(96, vmd.getDefaultVideoTrack().flatErrMap(p -> p.Height));
		assertOptEquals(25.0, vmd.getDefaultVideoTrack().flatErrMap(p -> p.FrameRate));
		assertOptEquals(137700, vmd.getDefaultVideoTrack().flatErrMap(p -> p.FrameCount));
		assertOptEmpty(vmd.getDefaultVideoTrack().flatErrMap(p -> p.BitDepth));
		assertOptEmpty(vmd.getDefaultVideoTrack().flatErrMap(p -> p.Duration));
		assertOptEquals(false, vmd.getDefaultVideoTrack().flatErrMap(p -> p.Default));
		...
		assertOptEquals(96, vmd.VideoTracks.get(0).Height);
		assertOptEquals(25.0, vmd.VideoTracks.get(0).FrameRate);
		assertOptEquals(137700, vmd.VideoTracks.get(0).FrameCount);
		assertOptEmpty(vmd.VideoTracks.get(0).BitDepth);
		assertOptEmpty(vmd.VideoTracks.get(0).Duration);
		assertOptEquals(false, vmd.VideoTracks.get(0).Default);
		assertOptEmpty(vmd.VideoTracks.get(0).calcCCDBLanguage());
	...
	@Test
	public void testMetadataRunner_051_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_051.mkv"));
	...
	@Test
	public void testMetadataRunner_052_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_052.mp4"));
	...
	@Test
	public void testMetadataRunner_053_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_053.mkv"));
	...
	@Test
	public void testMetadataRunner_054_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_054.avi"));
		...
		assertOptEquals(96, vmd.getDefaultVideoTrack().flatErrMap(p -> p.Height));
		assertOptEquals(25.0, vmd.getDefaultVideoTrack().flatErrMap(p -> p.FrameRate));
		assertOptEquals(188500, vmd.getDefaultVideoTrack().flatErrMap(p -> p.FrameCount));
		assertOptEmpty(vmd.getDefaultVideoTrack().flatErrMap(p -> p.BitDepth));
		assertOptEmpty(vmd.getDefaultVideoTrack().flatErrMap(p -> p.Duration));
		assertOptEquals(false, vmd.getDefaultVideoTrack().flatErrMap(p -> p.Default));
		...
		assertOptEquals(96, vmd.VideoTracks.get(0).Height);
		assertOptEquals(25.0, vmd.VideoTracks.get(0).FrameRate);
		assertOptEquals(188500, vmd.VideoTracks.get(0).FrameCount);
		assertOptEmpty(vmd.VideoTracks.get(0).BitDepth);
		assertOptEmpty(vmd.VideoTracks.get(0).Duration);
		assertOptEquals(false, vmd.VideoTracks.get(0).Default);
		assertOptEmpty(vmd.VideoTracks.get(0).calcCCDBLanguage());
	...
	@Test
	public void testMetadataRunner_055_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_055.mkv"));
	...
	@Test
	public void testMetadataRunner_056_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_056.mp4"));
	...
	@Test
	public void testMetadataRunner_057_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_057.mkv"));
	...
	@Test
	public void testMetadataRunner_058_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_058.avi"));
		...
		assertOptEquals(96, vmd.getDefaultVideoTrack().flatErrMap(p -> p.Height));
		assertOptEquals(25.0, vmd.getDefaultVideoTrack().flatErrMap(p -> p.FrameRate));
		assertOptEquals(145425, vmd.getDefaultVideoTrack().flatErrMap(p -> p.FrameCount));
		assertOptEmpty(vmd.getDefaultVideoTrack().flatErrMap(p -> p.BitDepth));
		assertOptEmpty(vmd.getDefaultVideoTrack().flatErrMap(p -> p.Duration));
		assertOptEquals(false, vmd.getDefaultVideoTrack().flatErrMap(p -> p.Default));
		...
		assertOptEquals(96, vmd.VideoTracks.get(0).Height);
		assertOptEquals(25.0, vmd.VideoTracks.get(0).FrameRate);
		assertOptEquals(145425, vmd.VideoTracks.get(0).FrameCount);
		assertOptEmpty(vmd.VideoTracks.get(0).BitDepth);
		assertOptEmpty(vmd.VideoTracks.get(0).Duration);
		assertOptEquals(false, vmd.VideoTracks.get(0).Default);
		assertOptEmpty(vmd.VideoTracks.get(0).calcCCDBLanguage());
	...
	@Test
	public void testMetadataRunner_059_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_059.mkv"));
	...
	@Test
	public void testMetadataRunner_060_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_060.mp4"));
	...
	@Test
	public void testMetadataRunner_061_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_061.mkv"));
	...
	@Test
	public void testMetadataRunner_062_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_062.avi"));
		...
		assertOptEquals(96, vmd.getDefaultVideoTrack().flatErrMap(p -> p.Height));
		assertOptEquals(25.0, vmd.getDefaultVideoTrack().flatErrMap(p -> p.FrameRate));
		assertOptEquals(157200, vmd.getDefaultVideoTrack().flatErrMap(p -> p.FrameCount));
		assertOptEmpty(vmd.getDefaultVideoTrack().flatErrMap(p -> p.BitDepth));
		assertOptEmpty(vmd.getDefaultVideoTrack().flatErrMap(p -> p.Duration));
		assertOptEquals(false, vmd.getDefaultVideoTrack().flatErrMap(p -> p.Default));
		...
		assertOptEquals(96, vmd.VideoTracks.get(0).Height);
		assertOptEquals(25.0, vmd.VideoTracks.get(0).FrameRate);
		assertOptEquals(157200, vmd.VideoTracks.get(0).FrameCount);
		assertOptEmpty(vmd.VideoTracks.get(0).BitDepth);
		assertOptEmpty(vmd.VideoTracks.get(0).Duration);
		assertOptEquals(false, vmd.VideoTracks.get(0).Default);
		assertOptEmpty(vmd.VideoTracks.get(0).calcCCDBLanguage());
	...
	@Test
	public void testMetadataRunner_063_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_063.mp4"));
	...
	@Test
	public void testMetadataRunner_064_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/demo_064.mkv"));
	...
	@Test
	public void testMetadataRunner_065_ffprobefull() throws Exception {
		CCMovieList ml = createEmptyDB();
		...
		var fvhash = dummyFVH();
		var attr = dummyFileAttr(946681200, 978303600, 1009839600, 1073741824);
		var vmd = new FFProbeFullRunner(ml).parse(out, fvhash, attr, FSPath.create("/temp/The Pale Blue Eye [GER+ENG].mkv"));
